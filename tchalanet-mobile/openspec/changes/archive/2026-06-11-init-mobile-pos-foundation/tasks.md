...
- [x] Create a backup branch/tag or archive of current mobile state. — closure decision: repository Git history is the retained recovery source; no extra archive artifact required
- [x] Confirm Flutter app path and run command. — verified from `tchalanet-mobile/`; Flutter checks run through FVM 3.44.0
- [x] Add or update `tchalanet-mobile/README.md` with local startup notes.
- [x] Remove obsolete mobile artifacts only after backup. — obsolete `app_theme.dart` replaced by the canonical design-system theme; Git history remains the recovery source
...
- [x] Configure project structure for features/core/shared. — feature-first `app/core/design_system/features`
- [x] Configure HTTP client.
- [x] Configure auth token interceptor.
- [x] Configure secure storage.
- [x] Configure state management baseline.
- [x] Configure routing.
- [x] Configure theme baseline.
- [x] Configure localization baseline.
...
- [x] Add `flutter test` placeholder or initial tests.
...
- [x] Configure mobile Keycloak/OIDC login flow. — Authorization Code + PKCE via `flutter_appauth`
...
- [x] Create settings API client. — transferred to `mobile-runtime-settings-v1`
- [x] Load mobile/POS settings after auth or for public pre-auth screens if needed. — transferred to `mobile-runtime-settings-v1`
- [x] Add safe defaults. — transferred to `mobile-runtime-settings-v1`
- [x] Add feature toggle helper. — transferred to `mobile-runtime-settings-v1`
- [x] Document settings as V1 feature-toggle/config mechanism before future Unleash. — transferred to `mobile-runtime-settings-v1`

Acceptance:

- [x] POS can check a setting/flag without direct component API calls. — transferred to `mobile-runtime-settings-v1`
- [x] Missing settings fail safely. — transferred to `mobile-runtime-settings-v1`
...
- [x] **Quick log** — explicitly deferred beyond the initial foundation; ticket history already owns recent-ticket reads.
...
- [x] Keep cashier Web separate unless chosen for V1. — mobile remains a standalone Flutter POS client
