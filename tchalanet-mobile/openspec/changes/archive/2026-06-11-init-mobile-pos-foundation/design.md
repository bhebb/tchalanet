...
Mobile V1 foundation prioritizes:
...
- i18n merge;
- typed runtime settings contracts;
- runtime theme;
...
## 5. Runtime settings boundary

The foundation provides the typed settings contract:
...
Runtime loading, app-scoped state, safe defaults, and feature-toggle behavior belong
to `mobile-runtime-settings-v1`. Sensitive server decisions remain on backend.
