...
### Runtime settings follow as a dedicated capability

The typed settings contract remains part of the foundation. Runtime loading and
feature-toggle behavior are implemented by the dedicated `mobile-runtime-settings-v1`
change against the stable backend runtime contracts.
