...
final i18nProvider = FutureProvider<I18nBundle>((ref) async {
  ...
  final publicOverrides = await ref.watch(
    _publicOverridesProvider(locale).future,
  );
  final tenantOverrides = await ref.watch(
    _tenantOverridesProvider(locale).future,
  );
