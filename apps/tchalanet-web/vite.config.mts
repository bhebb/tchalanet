...
export default defineConfig(({ mode }) => {
  ...
  console.log('>>> tchalanet-web Vite config.mts LOADED');
  ...
  return {
    ...
    // Dossier public (apps/tchalanet-web/public)
    ...
    css: {
      preprocessorOptions: {
        scss: {
          api: 'modern',
          // Depuis root: __dirname (apps/tchalanet-web), remonter de 2 niveaux vers racine monorepo
          includePaths: [
    ...
    // Build: NX veut dist/apps/tchalanet-web
    build: {
      outDir: path.resolve(__dirname, '../../dist/apps/tchalanet-web'),
      emptyOutDir: true,
    },
