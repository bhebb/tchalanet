...
@Component({
  ...
  template: `
    <main class="tch-page-error" role="alert">
      <p class="tch-page-error__code">{{ code() }}</p>
      <h1>{{ title() }}</h1>
  ...
  styles: [`
    ...
    .tch-page-error { display: grid; place-content: center; gap: 1rem; min-height: 60vh; max-width: var(--tch-page-max); margin: auto; padding: var(--tch-page-gutter); color: var(--comp-page-error-fg); text-align: center; }
