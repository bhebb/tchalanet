...
import { TCH_BRAND_ASSETS, TCH_SOCIAL_ASSETS } from '@tch/shared-assets';
...
export class PublicFooter {
  ...
  readonly brandImage = computed(() => this.brand()?.image ?? TCH_BRAND_ASSETS.logoInverse);
  ...
  constructor() {
    this.iconReg.addSvgIcon(
      'x',
      this.sanitizer.bypassSecurityTrustResourceUrl(TCH_SOCIAL_ASSETS.x),
    );
    this.iconReg.addSvgIcon(
      'facebook',
      this.sanitizer.bypassSecurityTrustResourceUrl(TCH_SOCIAL_ASSETS.facebook),
    );
    this.iconReg.addSvgIcon(
      'youtube',
      this.sanitizer.bypassSecurityTrustResourceUrl(TCH_SOCIAL_ASSETS.youtube),
    );
    this.iconReg.addSvgIcon(
      'instagram',
      this.sanitizer.bypassSecurityTrustResourceUrl(TCH_SOCIAL_ASSETS.instagram),
    );
    this.iconReg.addSvgIcon(
      'linkedin',
      this.sanitizer.bypassSecurityTrustResourceUrl(TCH_SOCIAL_ASSETS.linkedin),
    );
  }
}
