...
export class PublicResultsPage {
  ...
  readonly slotKeys = computed(() =>
    resolveSlotKeys(this.activeSlots(), this.providerFilter(), this.slotTypeFilter()),
  );
  ...
  readonly providerFilters = computed<
    readonly { readonly id: ProviderKey; readonly label: string }[]
  >(() => {
  ...
  readonly slotTypeFilters = computed<
    readonly { readonly id: SlotTypeKey; readonly labelKey: string }[]
  >(() => {
