...
import { PlatformCatalogApi, CatalogResultSlotView, UpdateResultSlotRequest } from '../../data-access/platform-catalog-api.service';
...
import { CreateResultSlotDialog } from '../../components/dialogs/create-result-slot.dialog';
