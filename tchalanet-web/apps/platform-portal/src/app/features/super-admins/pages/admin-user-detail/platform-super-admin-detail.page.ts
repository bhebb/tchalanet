...
@Component({
  ...
  templateUrl: './platform-super-admin-detail.page.html',
  styleUrls: ['./platform-super-admin-detail.page.scss'],
})
export class PlatformSuperAdminDetailPage implements OnInit {
