...
export class PlatformOpsApi {
  ...
  updateGate(jobKey: string, req: GateUpdateRequest, options?: TchRequestOptions): Observable<void> {
    return this.backend.put<void>(`/platform/ops/batch/gates/${jobKey}`, req, options);
  }

  // Draw Calendar
  generateDraws(req: GenerateDrawsRequest, options?: TchRequestOptions): Observable<OpsLaunchResponse> {
    return this.backend.post<OpsLaunchResponse>('/platform/ops/draws/generate', req, options);
  }

  openTodayDraws(req: OpenTodayDrawsRequest, options?: TchRequestOptions): Observable<OpsLaunchResponse> {
    return this.backend.post<OpsLaunchResponse>('/platform/ops/draws/open-today', req, options);
  }

  closeDueDraws(req: CloseDueDrawsRequest, options?: TchRequestOptions): Observable<OpsLaunchResponse> {
    return this.backend.post<OpsLaunchResponse>('/platform/ops/draws/close-due', req, options);
  }

  applyDrawResults(req: ApplyExternalResultsRequest, options?: TchRequestOptions): Observable<OpsLaunchResponse> {
    return this.backend.post<OpsLaunchResponse>('/platform/ops/draws/apply', req, options);
  }
  ...
  fetchDrawResults(req: FetchExternalResultsRequest, options?: TchRequestOptions): Observable<OpsLaunchResponse> {
    return this.backend.post<OpsLaunchResponse>('/platform/ops/draw-results/fetch', req, options);
  }

  overrideDrawResult(req: OverrideDrawResultRequest, options?: TchRequestOptions): Observable<unknown> {
    return this.backend.post<unknown>('/platform/ops/draw-results/override', req, options);
  }

  manualDrawResult(req: RecordManualDrawResultRequest, options?: TchRequestOptions): Observable<unknown> {
    return this.backend.post<unknown>('/platform/ops/draw-results/manual', req, options);
  }
  ...
  cancelDraw(drawId: string, req: CancelDrawRequest, tenantId?: string | null, options?: TchRequestOptions): Observable<DrawView> {
    return this.cancelDraws({ ...req, drawIds: [drawId] }, tenantId, options).pipe(map(rows => rows[0]));
  }
  ...
  lockDraw(drawId: string, reason?: string, tenantId?: string | null, options?: TchRequestOptions): Observable<DrawView> {
    return this.lockDraws({ drawIds: [drawId], reason }, tenantId, options).pipe(map(rows => rows[0]));
  }
  ...
  unlockDraw(drawId: string, reason?: string, tenantId?: string | null, options?: TchRequestOptions): Observable<DrawView> {
    return this.unlockDraws({ drawIds: [drawId], reason }, tenantId, options).pipe(map(rows => rows[0]));
  }
  ...
  settleDraw(drawId: string, reason?: string, tenantId?: string | null, options?: TchRequestOptions): Observable<DrawView> {
    return this.settleDraws({ drawIds: [drawId], reason }, tenantId, options).pipe(map(rows => rows[0]));
  }
  ...
  archiveDraw(drawId: string, reason?: string, force?: boolean, tenantId?: string | null, options?: TchRequestOptions): Observable<DrawView> {
    return this.archiveDraws({ drawIds: [drawId], reason, force }, tenantId, options).pipe(map(rows => rows[0]));
  }
  ...
  rescheduleDraw(drawId: string, scheduledAt: string, cutoffAt: string, reason: string, force?: boolean, tenantId?: string | null, options?: TchRequestOptions): Observable<DrawView> {
    return this.backend.post<DrawView>(`/admin/draws/${drawId}/reschedule`, { scheduledAt, cutoffAt, reason, force }, tenantAdminOptions(tenantId, 'SUPER_ADMIN: reschedule draw', options));
  }

  correctDrawResult(drawId: string, req: CorrectDrawResultRequest, tenantId?: string | null, options?: TchRequestOptions): Observable<DrawView> {
    return this.backend.post<DrawView>(
...
function tenantAdminOptions(
  ...
  return tenantId ? { ...(options ?? {}), asTenantAdmin: { tenantId, reason } } : options;
}
