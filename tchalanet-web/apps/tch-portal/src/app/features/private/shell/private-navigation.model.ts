    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            id: 'ops-communication-tests',
            labelKey: 'platform.nav.communicationTests',
            icon: 'send',
            destination: { kind: 'route', value: '/app/platform/ops/communication-tests' },
          },
          {
            id: 'ops-identity-sync',
            labelKey: 'platform.nav.identitySync',
            icon: 'sync_alt',
            destination: { kind: 'route', value: '/app/platform/ops/identity-sync' },
          },
          {
            id: 'ops-audit',
      ...
      },
      {
        ...
        labelKey: 'platform.nav.supportAndContent',
        icon: 'campaign',
        children: [
          {
            id: 'contact-requests',
          ...
          },
          {
            ...
            icon: 'contact_mail',
            destination: { kind: 'route', value: '/app/platform/contact-config' },
          },
        ],
      },
      {
