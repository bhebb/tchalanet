...
| keep summary                  | `SUMMARY`      | Curated portal/context summary; keep concise.             |   194 |
| link only                     | `LINK_ONLY`    | Keep near owner and expose via MkDocs links.              |   196 |
...
| `.claude/commands/opsx/apply.md`                                                                   | root/global            | UNKNOWN   | review ownership before moving or deleting                        |
| `.claude/commands/opsx/archive.md`                                                                 | root/global            | UNKNOWN   | review ownership before moving or deleting                        |
| `.claude/commands/opsx/bulk-archive.md`                                                            | root/global            | UNKNOWN   | review ownership before moving or deleting                        |
| `.claude/commands/opsx/continue.md`                                                                | root/global            | UNKNOWN   | review ownership before moving or deleting                        |
| `.claude/commands/opsx/explore.md`                                                                 | root/global            | UNKNOWN   | review ownership before moving or deleting                        |
| `.claude/commands/opsx/new.md`                                                                     | root/global            | UNKNOWN   | review ownership before moving or deleting                        |
| `.claude/commands/opsx/propose.md`                                                                 | root/global            | UNKNOWN   | review ownership before moving or deleting                        |
| `.claude/commands/opsx/sync.md`                                                                    | root/global            | UNKNOWN   | review ownership before moving or deleting                        |
| `.claude/commands/opsx/verify.md`                                                                  | root/global            | UNKNOWN   | review ownership before moving or deleting                        |
| `.claude/commands/review-backend.md`                                                               | root/global            | UNKNOWN   | review ownership before moving or deleting                        |
| `.claude/commands/task.md`                                                                         | root/global            | UNKNOWN   | review ownership before moving or deleting                        |
| `.claude/skills/documentation/SKILL.md`                                                            | root/global            | UNKNOWN   | review ownership before moving or deleting                        |
...
| `.github/prompts/opsx-apply.prompt.md`                                                             | root/global            | UNKNOWN   | review ownership before moving or deleting                        |
| `.github/prompts/opsx-archive.prompt.md`                                                           | root/global            | UNKNOWN   | review ownership before moving or deleting                        |
| `.github/prompts/opsx-bulk-archive.prompt.md`                                                      | root/global            | UNKNOWN   | review ownership before moving or deleting                        |
| `.github/prompts/opsx-continue.prompt.md`                                                          | root/global            | UNKNOWN   | review ownership before moving or deleting                        |
| `.github/prompts/opsx-explore.prompt.md`                                                           | root/global            | UNKNOWN   | review ownership before moving or deleting                        |
| `.github/prompts/opsx-new.prompt.md`                                                               | root/global            | UNKNOWN   | review ownership before moving or deleting                        |
| `.github/prompts/opsx-propose.prompt.md`                                                           | root/global            | UNKNOWN   | review ownership before moving or deleting                        |
| `.github/prompts/opsx-sync.prompt.md`                                                              | root/global            | UNKNOWN   | review ownership before moving or deleting                        |
| `.github/prompts/opsx-verify.prompt.md`                                                            | root/global            | UNKNOWN   | review ownership before moving or deleting                        |
...
| `apps/tchalanet-web/AGENTS.md`                                                                     | tchalanet-web          | UNKNOWN   | review ownership before moving or deleting                        |
