...
Use this page as the portal to active OpenSpec workspaces.

| Workspace | Location | Notes |
| --- | --- | --- |
...
| Docs | `tchalanet-docs/openspec/changes/` | Published documentation changes |

Generated inventory reports list the current Markdown files found in these
workspaces.
