...
:root {
  ...
  --elev-1: 0 1px 2px rgba(0, 0, 0, 0.08), 0 1px 1px rgba(0, 0, 0, 0.06);
  --elev-2: 0 2px 6px rgba(0, 0, 0, 0.1), 0 2px 2px rgba(0, 0, 0, 0.06);
  --elev-3: 0 4px 10px rgba(0, 0, 0, 0.12), 0 3px 3px rgba(0, 0, 0, 0.06);

  /* Typography (mobile-first) */
  --tch-h1: clamp(1.6rem, 2.5vw + 1.2rem, 2.4rem);
  --tch-h2: clamp(1.25rem, 1.6vw + 1rem, 1.6rem);
  --tch-h3: clamp(1.05rem, 0.9vw + 0.9rem, 1.25rem);
  --tch-body: 1rem;
  --tch-muted: 0.9rem;
  --tch-weight-bold: 700;
...
```scss
/* index.scss */
@use '../../../node_modules/.pnpm/@angular+material@20.2.2_287c6e0b7fcf3ed64c131b42d0a8e7e9/node_modules/@angular/material/index'
  as mat;
...
@function bp($n) {
  @return map-get($bps, $n);
}
@mixin up($n) {
  @media (min-width: bp($n)) {
    @content;
  }
}
```
