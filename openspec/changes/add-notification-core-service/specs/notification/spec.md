...
The system SHALL allow users to mark notifications as read and archive them.
...
The system SHOULD support preferences by tenant, role, or user to enable/disable channels per category/kind.
