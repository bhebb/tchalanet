...
- [x] Add Full Validation inputs for auth provider, infra ensure, runtime deploy, and optional perf.
- [x] Build API and edge-service images from the workflow SHA for validation deploys.
