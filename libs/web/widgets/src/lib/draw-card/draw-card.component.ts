...
import { DrawResult, NextDrawInfo } from '@tchl/types';
  ...
  styles: [
    `
      ...
      .ball {
        ...
        display: grid;
        place-items: center;
        background: var(--color-primary, #1e4dd8);
        color: var(--color-on-primary, #fff);
        font-weight: 700;
      }
      .ball.bonus {
        background: var(--color-tertiary, #ff3b3b);
      }
      .cd {
        display: flex;
        align-items: center;
    ...
    <mat-card appearance="outlined">
      ...
      <mat-card-content>
        <div class="wrap">
          ...
          } @else { @for (r of results(); track r.lotteryId + '-' + r.drawTime) {
          <div class="row">
            <div class="meta">
          ...
          <div class="cd">
            ...
            <span
              >Prochain tirage dans <strong class="tabnums">{{ countdown() }}</strong></span
            >
          </div>
          }
        </div>
