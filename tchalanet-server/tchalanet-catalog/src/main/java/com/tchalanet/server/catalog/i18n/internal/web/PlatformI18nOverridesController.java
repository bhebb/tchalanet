 ...
 * TENANT levels). TENANT_ADMIN access to tenant-scoped overrides is handled via {@code
 * features/tenantadmin} (TenantAdminI18nService).
 *
...
public class PlatformI18nOverridesController {
  ...
  public ApiResponse<TchPage<I18nOverrideView>> search(
    ...
    SearchI18nOverridesCriteria criteria =
        new SearchI18nOverridesCriteria(
            i18nLevel, locale, i18nKeyContains, active, null, null, "active");
  ...
  public ApiResponse<Map<String, String>> resolve(
      @PathVariable String locale, @CurrentContext TchRequestContext ctx) {
    ...
    return ApiResponse.success(
        new I18nGlobalOverviewView(
            ...
            new I18nGlobalOverviewView.Summary(
                stats.totalKeys(), stats.totalLocales(), stats.totalOverrides())));
  }
