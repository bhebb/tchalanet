...
public interface DrawChannelGameRepository extends JpaRepository<DrawChannelGameEntity, UUID> {
  ...
  Optional<DrawChannelGameEntity> findByTenantIdAndDrawChannelIdAndTenantGameIdAndDeletedAtIsNull(
      UUID tenantId, UUID drawChannelId, UUID tenantGameId);

  List<DrawChannelGameEntity> findByTenantIdAndDrawChannelIdAndTenantGameIdInAndDeletedAtIsNull(
      UUID tenantId, UUID drawChannelId, List<UUID> tenantGameIds);
}
