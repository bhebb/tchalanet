...
/** MapStruct mapper for Plan (JPA entity -> View). Uses CommonIdMapper for PlanId conversions. */
@Mapper(
    componentModel = "spring",
    uses = {CommonIdMapper.class})
public abstract class PlanMapper {

  @Autowired protected JsonUtils jsonUtils;

  @Autowired protected CommonIdMapper idMapper;

  /** Map JPA entity to immutable View. Converts JSON strings to JsonNode objects. */
