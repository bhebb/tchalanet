...
public class ThemePresetAdminService {
  ...
  @Transactional
  @CacheEvict(
      cacheNames = {ThemeCacheNames.ACTIVE_PRESETS, ThemeCacheNames.PRESET_BY_CODE},
      allEntries = true)
  ...
  public ThemePresetView update(ThemePresetId id, ThemePresetUpdateRequest req) {
    var e =
        repo.findById(id.value()).orElseThrow(() -> new RuntimeException("theme_preset_not_found"));
  ...
  public record ThemePresetCreateRequest(
      String code, String vendor, String configAsString, String labelKey, Boolean active) {}

  public record ThemePresetUpdateRequest(
      String code, String vendor, String configAsString, String labelKey, Boolean active) {}
}
