...
/**
 * Create a provider calendar override for a result_slot. Provide exactly one of {@code
 * slotLocalDate} (specific dated occurrence) or {@code recurringMd} (year-less 'MM-dd' annual rule)
 * — the service enforces the XOR.
 */
