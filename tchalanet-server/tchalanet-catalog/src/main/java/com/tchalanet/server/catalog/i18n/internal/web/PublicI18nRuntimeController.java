 ...
 *
 * <p>No authentication required. Only public surfaces are accepted. Any private surface in the
 * request causes 400 invalid_public_surface.
 */
@RestController
...
public class PublicI18nRuntimeController {
  ...
  @Operation(
      ...
      description =
          "Returns translations grouped by surface. surface is required. Any private surface causes 400.")
  @GetMapping("/public/i18n")
  public ApiResponse<I18nBundleView> getBundle(
      @RequestParam String locale, @RequestParam List<I18nSurface> surface) {
