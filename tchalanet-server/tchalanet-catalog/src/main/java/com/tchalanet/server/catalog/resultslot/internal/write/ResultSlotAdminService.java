...
public class ResultSlotAdminService {
  ...
  @CacheEvict(
      cacheNames = {
        ResultSlotCacheNames.ACTIVE,
        ResultSlotCacheNames.BY_KEY,
        ResultSlotCacheNames.BY_ID
      },
      allEntries = true)
  ...
  @CacheEvict(
      ...
      allEntries = true)
  public ResultSlotView updateSourceConfig(
      ResultSlotId id, UpdateResultSlotSourceConfigRequest req) {
  ...
  @CacheEvict(
      ...
      allEntries = true)
  public ResultSlotView updateProjectionConfig(
      ResultSlotId id, UpdateResultSlotProjectionConfigRequest req) {
  ...
  private void apply(
      com.tchalanet.server.catalog.resultslot.internal.web.model.BaseResultSlotRequest req,
      ResultSlotJpaEntity e) {
