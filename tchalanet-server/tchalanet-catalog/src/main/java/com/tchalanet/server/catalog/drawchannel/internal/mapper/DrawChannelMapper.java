...
public interface DrawChannelMapper {
  ...
  @Mapping(
      target = "timezone",
      expression = "java(req.timezone() == null ? null : req.timezone().toString())")
  @Mapping(
      target = "cutoffSec",
      expression = "java(req.cutoffSec() == null ? 120 : req.cutoffSec())")
  @Mapping(
      target = "daysOfWeek",
      expression =
          "java(com.tchalanet.server.common.time.DaysOfWeekFormatter.format(req.daysOfWeek()))")
  ...
  @Mapping(
      target = "timezone",
      expression = "java(view.timezone() == null ? null : view.timezone().toString())")
  @Mapping(
      target = "daysOfWeek",
      expression =
          "java(com.tchalanet.server.common.time.DaysOfWeekFormatter.format(view.daysOfWeek()))")
  ...
  void updateEntityFromRequest(
      UpdateDrawChannelRequest req, @MappingTarget DrawChannelEntity entity);
}
