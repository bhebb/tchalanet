 ...
 *
 * <p>These JSON files are catalog template definitions: metadata + schema + model.
 *
 * <p>Belongs to catalog.pagemodeltemplate because it seeds catalog templates, not tenant PageModel
 * instances.
 */
@Component
