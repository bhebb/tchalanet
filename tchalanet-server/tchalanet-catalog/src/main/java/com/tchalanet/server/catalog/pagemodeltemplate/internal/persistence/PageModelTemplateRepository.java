...
public interface PageModelTemplateRepository
    extends JpaRepository<PageModelTemplateEntity, UUID>,
        JpaSpecificationExecutor<PageModelTemplateEntity> {
  ...
  List<PageModelTemplateEntity> findByIsDefaultAndLevelAndDeletedAtIsNullOrderByLogicalId(
      boolean isDefault, PageModelTemplateLevel level);
}
