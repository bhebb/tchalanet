...
/**
 * Formats draw channel display labels for UI/print. Replaces legacy DrawChannelLabelResolver from
 * core.draw.
 *
 * <p>This formatter now uses structured {@code draw_channel.period} field instead of parsing {@code
 * shortLabel()} from channel name.
 *
...
public class DrawChannelDisplayFormatter {
  ...
  /**
   * Resolves full channel label from DrawChannelView. Format: "Channel Name (HH:mm)"
   *
  ...
  /**
   * Resolves period label from structured period field. Uses {@code draw_channel.period} instead of
