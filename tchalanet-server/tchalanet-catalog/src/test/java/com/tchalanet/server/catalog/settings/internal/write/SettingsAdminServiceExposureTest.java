...
/**
 * Unit tests for SettingsAdminService.listActiveByExposure(). Uses Mockito.mock() for all
 * dependencies — decouple from record/entity field changes.
 */
class SettingsAdminServiceExposureTest {
  ...
  private final SettingsAdminService service = new SettingsAdminService(repository, mapper);
