 ...
 *
 * <p>Uses Mockito.mock() for repository and entity to decouple from field additions in
 * I18nOverrideEntity.
 */
class I18nOverridesCatalogImplBundleTest {
  ...
  private final I18nOverridesCatalogImpl catalog = new I18nOverridesCatalogImpl(repository, mapper);
  ...
  void multipleSurfacesReturnedGrouped() {
    ...
    assertThat(bundle.surfaces().get(I18nSurface.PUBLIC_RESULTS))
        .containsEntry("results.title", "Résultats");
  }
