...
ALTER TABLE seller_terminal_settings
  ADD COLUMN quick_sale boolean NOT NULL DEFAULT true,
  ADD COLUMN receipt_printer_mode varchar(32) NOT NULL DEFAULT 'POS_DIRECT',
  ADD COLUMN receipt_paper_size varchar(32) NOT NULL DEFAULT 'RECEIPT_58MM',
