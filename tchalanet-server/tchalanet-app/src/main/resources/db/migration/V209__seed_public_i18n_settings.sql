...
WITH public_i18n(surface, locale, i18n_key, i18n_value) AS (VALUES
  ...
  -- PUBLIC_HOME
  ('PUBLIC_HOME', 'fr', 'home.hero.eyebrow',     'Tchalanet'),
  ('PUBLIC_HOME', 'fr', 'home.hero.tagline',     'Tchalanet'),
  ('PUBLIC_HOME', 'fr', 'home.hero.title',       'Une plateforme. Tout l’écosystème de la loterie.'),
  ('PUBLIC_HOME', 'fr', 'home.hero.subtitle',    'Vente, gestion, tirages, résultats et vérification des tickets réunis dans une même plateforme.'),
  ('PUBLIC_HOME', 'fr', 'home.hero.cta',         'Découvrir Tchalanet'),
  ('PUBLIC_HOME', 'fr', 'home.hero.secondary_cta', 'Vérifier un ticket'),
  ('PUBLIC_HOME', 'fr', 'home.nav.check_ticket', 'Vérifier'),
  ('PUBLIC_HOME', 'fr', 'home.nav.results',      'Résultats'),

  ('PUBLIC_HOME', 'en', 'home.hero.eyebrow',     'Tchalanet'),
  ('PUBLIC_HOME', 'en', 'home.hero.tagline',     'Tchalanet'),
  ('PUBLIC_HOME', 'en', 'home.hero.title',       'One platform. The whole lottery ecosystem.'),
  ('PUBLIC_HOME', 'en', 'home.hero.subtitle',    'Sales, management, draws, results and ticket verification brought together in one platform.'),
  ('PUBLIC_HOME', 'en', 'home.hero.cta',         'Discover Tchalanet'),
  ('PUBLIC_HOME', 'en', 'home.hero.secondary_cta', 'Verify a ticket'),
  ('PUBLIC_HOME', 'en', 'home.nav.check_ticket', 'Check'),
  ('PUBLIC_HOME', 'en', 'home.nav.results',      'Results'),

  ('PUBLIC_HOME', 'ht', 'home.hero.eyebrow',     'Tchalanet'),
  ('PUBLIC_HOME', 'ht', 'home.hero.tagline',     'Tchalanet'),
  ('PUBLIC_HOME', 'ht', 'home.hero.title',       'Yon sèl platfòm. Tout ekosistèm lotri a.'),
  ('PUBLIC_HOME', 'ht', 'home.hero.subtitle',    'Vant, jesyon, tiraj, rezilta ak verifikasyon tikè yo reyini nan yon sèl platfòm.'),
  ('PUBLIC_HOME', 'ht', 'home.hero.cta',         'Dekouvri Tchalanet'),
  ('PUBLIC_HOME', 'ht', 'home.hero.secondary_cta', 'Verifye yon tikè'),
