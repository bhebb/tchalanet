...
@ContextConfiguration(
    initializers = BusinessRuntimeIntegrationTestBase.FlywayContainerInitializer.class)
abstract class BusinessRuntimeIntegrationTestBase {
  ...
  void setUpBusinessRuntimeFixture() {
    var tenantUuid =
        jdbc.queryForObject("select id from tenant where code = 'tchalanet'", UUID.class);
    ...
    return tenantAdminContext(tenantUuid)
        ...
        .withOperationalContext(
            new OperationalContextHint(
                OperationalContextSource.SERVER_BOOTSTRAP, OperationalContextTrust.STRONG));
  }
