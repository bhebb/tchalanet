...
class BatchNotificationPolicyTest {
    ...
    private Clock clock;
    private com.tchalanet.server.platform.notification.internal.batch.BatchNotificationPolicy policy;

    @BeforeEach
    void setUp() {
        clock = Clock.fixed(Instant.parse("2026-05-04T12:00:00Z"), ZoneId.of("UTC"));
        policy = new com.tchalanet.server.platform.notification.internal.batch.BatchNotificationPolicy(cacheManager, clock);
    }
