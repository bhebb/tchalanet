...
| User Context   | `platform.identity`   | user/profile/context API                                            | app user profile, display label, preferences, Keycloak mapping                       | high fan-in bridge migration expected      |
