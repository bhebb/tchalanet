...
class CashierUser(User):
    ...
    def sell_basket(self) -> None:
        ...
        try:
            self.flow.preview_lines(draw, lines)  # timed as POST /tenant/cashier/tickets/preview
            self.flow.sell_lines(draw, lines)     # timed as POST /tenant/cashier/tickets/sell
        except Exception:
