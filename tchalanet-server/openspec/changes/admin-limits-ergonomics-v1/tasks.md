...
- [x] Add tenantadmin policies overview response model.
- [x] Add tenantadmin policies overview service.
- [x] Add `GET /admin/policies/overview` controller.
- [x] Validate server compile.
