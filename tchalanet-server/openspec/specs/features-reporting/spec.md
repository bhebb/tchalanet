# features-reporting Specification

## Purpose

`features.reporting` owns report presentation and export orchestration only. It sources
all metrics and KPIs from `core.analytics` through `QueryBus`; it does not compute
core KPI definitions itself.
