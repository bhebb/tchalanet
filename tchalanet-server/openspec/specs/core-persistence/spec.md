...
Define persistence invariants for sensitive backend aggregates so existing rows are
updated through managed JPA mutation or guarded SQL, never through detached merge of a
