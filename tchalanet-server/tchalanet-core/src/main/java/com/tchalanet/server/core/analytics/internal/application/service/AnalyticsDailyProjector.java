 ...
 *
 * <p>Business decisions (which dimensions to update, which event fields to read) live here in Java
 * — the SQL function is a pure atomic increment primitive.
 *
 * <p>Callers (AnalyticsEventListener) ensure idempotence via ProcessedEventPort before invoking any
 * method here.
 */
@Component
...
public class AnalyticsDailyProjector {
  ...
  private record ChargeTotals(
      long buyerCents, long sellerCents, long tenantCents, long waivedCents) {
