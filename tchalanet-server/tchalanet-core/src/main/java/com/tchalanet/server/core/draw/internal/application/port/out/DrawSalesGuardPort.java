...
/**
 * Port pour valider les opérations sur les draws par rapport à l'état des sales. Bloque certaines
 * opérations si des tickets/payouts sont dans un état incompatible.
 */
public interface DrawSalesGuardPort {
   ...
   * @param force si true, autorise l'annulation même avec des tickets vendus (si void/refund
   *     possible)
   ...
   */
  void assertCanCorrectAppliedResult(
