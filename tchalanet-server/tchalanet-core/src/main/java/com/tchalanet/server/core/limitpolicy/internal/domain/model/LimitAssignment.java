...
public record LimitAssignment(
  ...
  public static LimitAssignment createNew(
    ...
    return new LimitAssignment(
        id, ruleKey, scopeRef, enabled, onBreach, params, startsAt, endsAt, false);
  }

  public LimitAssignment update(
      boolean enabled, BreachOutcome onBreach, JsonNode params, Instant startsAt, Instant endsAt) {
    return new LimitAssignment(
        id, ruleKey, scope, enabled, onBreach, params, startsAt, endsAt, deleted);
  }
}
