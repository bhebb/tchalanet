...
/**
 * Handler de preview admin : retourne le PageModelAdminDetailDto mappé sans résolution dynamique.
 * Pas de fallback tenant → default ; RLS garantit l'appartenance au tenant courant.
 */
@UseCase
