...
public interface PromotionCacheEvictorPort {
  ...
  void evictAfterCampaignMutation(TenantId tenantId, PromotionCampaignId campaignId);

  void evictRuntimeForTenant(TenantId tenantId);

  void evictCampaignDetail(TenantId tenantId, PromotionCampaignId campaignId);
