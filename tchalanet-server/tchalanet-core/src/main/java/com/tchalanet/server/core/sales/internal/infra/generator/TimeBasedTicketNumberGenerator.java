 ...
 *
 * <p>Why: - Human-friendly prefix and time component for debugging/troubleshooting - Random suffix
 * to make collisions extremely unlikely - Check digit to catch manual input mistakes
 *
 * <p>Format: TCK-YYMMDD-HHMMSS-XXXXXX-C Example: TCK-260113-214501-9K3W2H-7
 */
@Component
public class TimeBasedTicketNumberGenerator {
  ...
  /**
   * Simple mod-10 check digit (not crypto). Goal: catch common mistakes when staff types the ticket
   * code.
   */
