...
public class DeletePromotionRuleCommandHandler implements CommandHandler<DeletePromotionRuleCommand, PromotionCampaignView> {

    private final PromotionCampaignWritePort writePort;
    private final PromotionCacheEvictorPort cacheEvictor;

    @Override
    public PromotionCampaignView handle(DeletePromotionRuleCommand cmd) {
        var out = writePort.deleteRule(cmd);
