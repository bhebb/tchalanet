...
/**
 * Matches Tchalanet result_slot.source_cfg.provider_slot_code against provider-native slot
 * labels/draw types.
 *
 * <p>Internal slot_key remains the Tchalanet identity (GA_EVE, TX_1000, ...). provider_slot_code is
 * the external-provider matching hint (MIDDAY, EVENING, ...).
 */
public final class ProviderSlotCodeMatcher {
  ...
  public static String normalize(String value) {
    return value == null ? "" : value.trim().toUpperCase(Locale.ROOT).replaceAll("[\\s_\\-]+", "");
  }
}
