# Domaine core.terminal — Points de vente & Terminaux (sessions + devices)
...
- `SalesSession`: id, tenant, outletId, terminalId, userId, openedAt, closedAt, status.
...
- `OpenSalesSessionCommandHandler`
- `CloseSalesSessionCommandHandler`
- `ListSalesSessionsQueryHandler`
