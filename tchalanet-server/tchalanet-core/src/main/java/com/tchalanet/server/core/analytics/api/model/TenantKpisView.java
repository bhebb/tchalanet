 ...
 *
 * <p>Used by both the reporting endpoint and any dashboard consumer. Values are derived from the
...
public record TenantKpisView(
  ...
  public static TenantKpisView empty() {
    return new TenantKpisView(0L, BigDecimal.ZERO, BigDecimal.ZERO, BigDecimal.ZERO, 0L, 0L);
  }
}
