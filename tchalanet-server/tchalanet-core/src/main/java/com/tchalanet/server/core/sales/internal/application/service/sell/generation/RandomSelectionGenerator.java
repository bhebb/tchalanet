 ...
 *
 * <p>Output is a raw selection string accepted by {@code SelectionKeyCanonicalizer} for the given
 * bet type; callers must still canonicalize via {@code SelectionApi}.
 */
@Component
public class RandomSelectionGenerator {
  ...
  /**
   * Two distinct 2-digit numbers ("a-b"). A maryaj of a number with itself is rejected by business
   * rule, even though canonicalization accepts it.
   */
