...
/**
 * Default offline policy used by {@code GetOfflineLimitPolicyQueryHandler} when no per-tenant
 * override is configured.
 *
 * <p>TODO Phase G/H: back this with a persisted per-tenant policy table; the static defaults below
 * cover dev + first-launch tenants.
 */
