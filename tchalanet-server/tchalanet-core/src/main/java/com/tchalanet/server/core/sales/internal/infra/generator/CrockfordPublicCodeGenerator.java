 ...
 *
 * <p>Requirements: - Short and human-friendly - Non-guessable (random) - Avoid ambiguous characters
 * (Crockford Base32)
 *
 * <p>Note: collisions are extremely unlikely, but still possible. Handle collision by retrying when
