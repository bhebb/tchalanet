 ...
 *
 * <p>Charges are fully exposed so consumers (ledger, reporting) can route each type of money to the
 * right account. Buyer-facing charges sum to {@code total - stake}.
 */
public record TicketMoneyPayload(
    CurrencyCode currency, Money stake, Money total, List<ChargeItem> charges) {
