...
/**
 * Snapshots the sale input on prepare and rebuilds the exact {@link SellTicketCommand} at confirm —
 * with the stored generated promotion selections pinned via {@code promotionChoices} so the
 * confirmed ticket carries exactly the previewed numbers.
 */
@Component
public class SalePreparationInputCodec {
  ...
  public Map<String, Object> toMap(SellTicketCommand command) {
    ...
    out.put(
        "drawChannelId",
        command.drawChannelId() == null ? null : command.drawChannelId().value().toString());
  ...
  public SellTicketCommand fromMap(
      Map<String, Object> input, List<PromotionChoiceInput> promotionChoices) {
            ...
            .map(
                l ->
                    new SellTicketLineInput(
                        ...
                        l.get("betOption") == null
                            ? null
                            : ((Number) l.get("betOption")).shortValue(),
    ...
    if (input.get("communication") instanceof Map<?, ?> raw) {
      ...
      comm =
          new SaleCommunicationOptions(
              ...
              c.get("buyerLocale") == null
                  ? null
                  : Locale.forLanguageTag((String) c.get("buyerLocale")));
    }
    ...
    return new SellTicketCommand(
        ...
        input.get("drawChannelId") == null
            ? null
            : DrawChannelId.of(UUID.fromString((String) input.get("drawChannelId"))),
