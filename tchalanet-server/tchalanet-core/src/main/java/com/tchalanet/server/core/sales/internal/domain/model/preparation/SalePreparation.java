...
/**
 * Working trace of a prepared sale (DOMAIN_SALES.md §11). The persisted ticket stays the financial
 * truth; this object pins the previewed lines so confirm persists exactly what the seller saw.
 */
