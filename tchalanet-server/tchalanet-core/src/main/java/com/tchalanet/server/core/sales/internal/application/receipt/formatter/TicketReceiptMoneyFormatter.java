...
public class TicketReceiptMoneyFormatter {
  ...
  /**
   * For receipt paper (compact currency display) provide a single-line currency note e.g. "Montants
   * en HTG" to avoid repeating the currency on every line.
   */
  public String currencyNote(
      Money money, TicketReceiptLayoutProfile profile, TicketReceiptTranslations translations) {
