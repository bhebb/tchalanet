...
public class UsLotteryConfig {
  ...
  @Bean
  @ConditionalOnProperty(
      prefix = "tch.us-lottery.providers.mn",
      name = "enabled",
      havingValue = "true",
      matchIfMissing = true)
  public RestClient mnLotteryRestClient(RestClientFactory builder, UsLotteryProperties props) {
    return getRestClient(builder, props, MN_PROVIDER_KEY);
  }
  ...
  private RestClient getRestClient(
      RestClientFactory factory, UsLotteryProperties props, String providerKey) {
  ...
  private RestClient.Builder applyProxy(RestClient.Builder builder, UsLotteryProperties props) {
    ...
    log.warn("Wiring LotteryProxyInterceptor with proxyUrl={}", props.getProxyUrl());
