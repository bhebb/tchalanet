...
public interface TenantOfflinePolicyReaderPort {
  ...
  /**
   * @return the tenant-specific offline policy, or empty if none configured (caller falls back to
   *     the global defaults from {@link
   *     com.tchalanet.server.core.limitpolicy.internal.infra.config.OfflineLimitPolicyProperties}).
   */
