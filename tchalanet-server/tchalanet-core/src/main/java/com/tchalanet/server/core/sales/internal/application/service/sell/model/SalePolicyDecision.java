...
public record SalePolicyDecision(
  ...
  public SalePolicyDecision {
    ...
    if (!requiresApproval && approvalLevel != null) {
      throw new IllegalArgumentException(
          "approvalLevel must be null when approval is not required");
    }
  }
  ...
  public static SalePolicyDecision requiresApproval(
      LimitEvaluationView limits, AutonomyLevel level) {
