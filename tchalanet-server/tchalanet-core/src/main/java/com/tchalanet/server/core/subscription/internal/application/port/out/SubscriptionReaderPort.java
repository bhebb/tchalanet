...
/**
 * Port for reading subscription data (read-only). Maps to spec requirement S2 (resolve tenant
 * subscription).
 */
public interface SubscriptionReaderPort {

  /** Find subscription by tenant ID. Returns empty if no subscription exists for tenant. */
