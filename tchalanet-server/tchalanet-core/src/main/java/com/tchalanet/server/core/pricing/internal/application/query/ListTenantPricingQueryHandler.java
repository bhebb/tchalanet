...
public class ListTenantPricingQueryHandler
    implements QueryHandler<ListTenantPricingQuery, List<TenantPricingOddsView>> {

    private final TenantPricingOddsReaderPort reader;
    private final TenantPricingOddsMapper mapper;

    @Override
    public List<TenantPricingOddsView> handle(ListTenantPricingQuery q) {
