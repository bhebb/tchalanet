...
/**
 * Réinitialise un PageModel à partir du modèle par défaut de son template lié. Si pas de template :
 * remet le modèle à {}.
 *
 * <p>Après reset, publie after-commit un PageModelResetEvent pour invalider le cache BFF public de
 * l'instance.
 *
 * <p>Conforme event_model.md §4.1 (AfterCommit) + command_query_handlers.md §3.2.
 */
@UseCase
