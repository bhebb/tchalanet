...
public class DrawCacheSpecProvider implements CacheSpecProvider {
  ...
  public List<CacheSpec> cacheSpecs() {
    return List.of(
        CacheSpec.of(DRAW_SUMMARY_SEARCH, L1_SHORT, L2_SHORT),
        CacheSpec.of(DRAW_TODAY_SEARCH, L1_SHORT, L2_SHORT),
        CacheSpec.of(DRAW_UPCOMING_SEARCH, L1_SHORT, L2_SHORT),
        CacheSpec.of(DRAW_NEXT_SEARCH, L1_NEXT, L2_NEXT),
        CacheSpec.of(DRAW_LATEST_RESULTS_SEARCH, L1_LATEST, L2_LATEST));
  }
}
