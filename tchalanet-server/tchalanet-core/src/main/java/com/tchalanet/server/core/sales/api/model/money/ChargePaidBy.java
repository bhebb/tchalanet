 ...
 *
 * <ul>
 *   <li>{@link #BUYER}: included in the ticket's buyer-facing {@code total}.
 *   <li>{@link #SELLER}: deducted from the seller's commission / margin (out of band).
 *   <li>{@link #TENANT}: tenant absorbs the cost as an operating expense.
 * </ul>
 */
