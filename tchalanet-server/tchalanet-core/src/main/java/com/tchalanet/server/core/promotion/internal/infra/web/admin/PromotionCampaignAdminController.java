...
public class PromotionCampaignAdminController {
  ...
  public ApiResponse<PromotionCampaignView> get(@PathVariable UUID campaignId) {
  ...
  public ApiResponse<PromotionCampaignView> activate(
      @CurrentContext TchRequestContext ctx, @PathVariable UUID campaignId) {
    var result =
        commandBus.execute(
            new ActivatePromotionCampaignCommand(
                ctx.tenantIdRequired(), PromotionCampaignId.of(campaignId)));
    return ApiResponse.success(result);
  }
  ...
  public ApiResponse<PromotionCampaignView> deactivate(
    ...
    var result =
        commandBus.execute(
            new DeactivatePromotionCampaignCommand(
                ctx.tenantIdRequired(), PromotionCampaignId.of(campaignId)));
    return ApiResponse.success(result);
  }
  ...
  public ApiResponse<PromotionCampaignView> pause(
    ...
    var out =
        commandBus.execute(
            new PausePromotionCampaignCommand(
                ctx.tenantIdRequired(), PromotionCampaignId.of(campaignId)));
  ...
  public ApiResponse<PromotionCampaignView> archive(
    ...
    var out =
        commandBus.execute(
            new ArchivePromotionCampaignCommand(
                ctx.tenantIdRequired(), PromotionCampaignId.of(campaignId)));
    return ApiResponse.success(out);
  }
}
