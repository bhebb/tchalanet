...
public record TicketLine(
  ...
  public TicketLine {
    ...
    selectionSource =
        selectionSource == null ? TicketLineSelectionSource.CUSTOMER_SELECTED : selectionSource;
    ...
    if (origin == TicketLineOrigin.CUSTOMER
      ...
      throw new IllegalArgumentException(
          "ticket_line.standard_customer_line_cannot_have_promotion");
    }
  ...
  public TicketLine withResult(
      com.tchalanet.server.core.sales.api.model.line.TicketLineResult result) {
  ...
  private SettlementTermsSnapshot boostSettlementTerms(BigDecimal boostedOddsSnapshot) {
    var boostedTerms =
        settlementTermsSnapshot.terms().stream()
            .map(
                term ->
    ...
    var term =
        new SettlementTermSnapshot(
            SettlementRuleCode.fromPricingVariant(
                com.tchalanet.server.core.sales.internal.domain.service.result
                    .SettlementVariantResolver.resolve(
                    betType, betOption, selection == null ? null : selection.key().value())),
