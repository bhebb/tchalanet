 ...
 *
 * <p>The underlying view is created with security_invoker=true and relies on source-table RLS. This
 * entity is projection-only and must never be used for updates.
 */
@Entity
@Immutable
@Getter
