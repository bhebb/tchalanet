...
public class DrawQueryAdminController {
  ...
  public ApiResponse<TchPage<DrawSummaryResponse>> nextDraws(
    ...
    TchPage<DrawSummary> page =
        queryBus.ask(
            new ListNextDrawsQuery(
                resultSlotId, lookaheadHours, limitPerChannel, pageReq.pageable()));
  ...
  @GetMapping("/{drawId}")
  public ApiResponse<DrawSummaryResponse> getDraw(@PathVariable DrawId drawId) {
