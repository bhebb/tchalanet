...
/**
 * Generates a valid, canonical selection for a given game, according to an authorised strategy, in
 * a sale or promotion context.
 *
 * <p>Promotion never generates numbers: it decides the effect, sales generates and materialises
 * (see {@code DOMAIN_SALES.md} §11 and {@code promotion_design.md} §16).
 */
public interface SelectionGenerationService {
   ...
   * @throws IllegalArgumentException when the strategy is unsupported or the game/betType/betOption
