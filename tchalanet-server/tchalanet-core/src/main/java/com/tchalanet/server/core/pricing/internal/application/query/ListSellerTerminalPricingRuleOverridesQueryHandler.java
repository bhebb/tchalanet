...
public class ListSellerTerminalPricingRuleOverridesQueryHandler
    implements QueryHandler<
        ListSellerTerminalPricingRuleOverridesQuery, List<SellerTerminalPricingRuleOverrideView>> {

  private final SellerTerminalOddsOverrideReaderPort reader;
  private final SellerTerminalOddsOverrideMapper mapper;

  @Override
  public List<SellerTerminalPricingRuleOverrideView> handle(
      ListSellerTerminalPricingRuleOverridesQuery q) {
    return reader.findActiveBySellerTerminal(q.tenantId(), q.sellerTerminalId()).stream()
        .map(mapper::toView)
        .toList();
  }
}
