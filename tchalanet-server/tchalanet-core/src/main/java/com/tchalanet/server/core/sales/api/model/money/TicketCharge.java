 ...
 * ticket's {@code total}. Waived charges keep their original amount for audit and print display but
 * are excluded from the buyer-facing total.
 */
public record TicketCharge(
  ...
  public TicketCharge(
      TicketChargeType type, Money amount, ChargePaidBy paidBy, PromotionRuleId waivedByRuleId) {
  ...
  public TicketCharge asWaived(
      PromotionDecisionId decisionId, PromotionRuleId ruleId, String effectType, String label) {
