...
public class DrawResultsController {
  ...
  public ApiResponse<TchPage<DrawResultResponse>> list(
    ...
    var page =
        queryBus.ask(
            new ListDrawResultsQuery(slotKey, status, quality, from, to, pageReq.pageable()));
  ...
  public ApiResponse<TchPage<DrawResultResponse>> listToday(
    ...
    var page =
        queryBus.ask(
            new ListDrawResultsQuery(slotKey, status, quality, today, today, pageReq.pageable()));
  ...
  private TchPage<DrawResultResponse> toResponsePage(TchPage<DrawResultView> page) {
