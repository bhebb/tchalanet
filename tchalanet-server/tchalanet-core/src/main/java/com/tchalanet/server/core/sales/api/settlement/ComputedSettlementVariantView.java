 ...
 *
 * <ul>
 *   <li>{@code variant} — technical settlement variant code (e.g. {@code LOTTO4_BOX_24_WAY}).</li>
 *   <li>{@code commercialLabel} — sale-friendly label shown to seller/client
 *       (e.g. {@code Permuté}).</li>
 *   <li>{@code adminLabel} — admin/support label that may expose the technical variant
 *       (e.g. {@code Permuté · 24-way}).</li>
 * </ul>
 *
