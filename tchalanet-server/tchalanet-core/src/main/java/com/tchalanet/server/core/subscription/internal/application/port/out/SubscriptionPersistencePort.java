...
/**
 * Port for writing subscription data (persistence). Maps to spec requirement S1 (persist
 * subscription state).
 */
public interface SubscriptionPersistencePort {

  /** Save or update subscription. Increments version (optimistic locking per S4). */
