...
public class DefaultSelectionGenerationService implements SelectionGenerationService {
  ...
  public DefaultSelectionGenerationService(
      RandomSelectionGenerator randomSelectionGenerator, SelectionApi selectionApi) {
  ...
  public Selection generate(
    ...
    if (!gameCode.supports(betType)) {
      throw new IllegalArgumentException(
          "selection.generation.bet_type_not_supported_for_game: " + gameCode + "/" + betType);
    }
    if (strategy != SelectionGenerationStrategy.RANDOM) {
      throw new IllegalArgumentException("selection.generation.strategy_unsupported: " + strategy);
    }
