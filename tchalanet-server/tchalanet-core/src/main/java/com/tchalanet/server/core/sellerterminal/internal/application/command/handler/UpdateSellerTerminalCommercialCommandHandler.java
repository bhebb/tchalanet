...
public class UpdateSellerTerminalCommercialCommandHandler
    implements CommandHandler<UpdateSellerTerminalCommercialCommand, Void> {
  ...
  @Override
  @TchTx
  public Void handle(UpdateSellerTerminalCommercialCommand cmd) {
