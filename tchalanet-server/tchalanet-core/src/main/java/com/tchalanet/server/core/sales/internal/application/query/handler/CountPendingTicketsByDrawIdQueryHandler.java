...
public class CountPendingTicketsByDrawIdQueryHandler
    implements QueryHandler<CountPendingTicketsByDrawIdQuery, Long> {
  ...
  public Long handle(CountPendingTicketsByDrawIdQuery query) {
    ...
    return ticketJpaRepository.countByDrawIdAndSettlementStatusIn(
