...
public class PromotionOddsBoostApplier {
  ...
  public void apply(List<TicketLine> lines, PromotionEffect effect, PromotionDecision decision) {
    ...
    for (int i = 0; i < lines.size(); i++) {
      ...
      lines.set(
          i,
          line.withPromotionPricing(
              boostedOdds, decision.decisionId(), promotionLabel(effect), effect.type().name()));
    }
  }
