...
public record TicketCodes(
    TicketCode ticketCode, PublicCode publicCode, VerificationCode verificationCode) {
  public TicketCodes {
    if (ticketCode == null) {
  ...
  public static TicketCodes from(String ticketCode, String publicCode, String verificationCode) {
    return new TicketCodes(
        TicketCode.ofNullable(ticketCode),
        PublicCode.ofNullable(publicCode),
        VerificationCode.ofNullable(verificationCode));
  }
}
