...
public class GetTenantKpisQueryHandler implements QueryHandler<GetTenantKpisQuery, TenantKpisView> {
  ...
  public TenantKpisView handle(GetTenantKpisQuery query) {
    ...
    return reader.computeTenantKpis(query.tenantId().value(), query.fromDate(), query.toDate());
  }
}
