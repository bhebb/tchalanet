...
public class VirtualPhoneTerminalActivationController {

    private final CommandBus commandBus;

    @PostMapping
    @ResponseStatus(HttpStatus.CREATED)
    @Operation(summary = "Create a mobile OTP challenge for a virtual phone terminal")
    @RequiresPermission("terminal.phone.challenge.create")
    @AuditLog(
    ...
    @Operation(summary = "Verify a mobile OTP challenge and bind the app instance")
    @RequiresPermission("terminal.phone.binding.create")
    @AuditLog(
        entity = AuditEntityType.TERMINAL,
    ...
    private static TerminalChallengeDeliveryMode deliveryModeOrLive(CreateTerminalActivationChallengeRequest request) {
