...
/** Minnesota — Manual provider for now. Only Pick3 is supported. */
@Component
@Slf4j
public class MinnesotaDrawResultsClient implements UsLotteryProviderClient {
  ...
  public MinnesotaDrawResultsClient(
      @org.springframework.beans.factory.annotation.Qualifier("mnLotteryRestClient")
