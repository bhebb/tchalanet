...
import com.tchalanet.server.core.terminal.internal.infra.web.admin.model.BlockSellerTerminalRequest;
import com.tchalanet.server.core.terminal.internal.infra.web.admin.model.CreateSellerTerminalRequest;
import com.tchalanet.server.core.terminal.internal.infra.web.admin.model.UpdateSellerTerminalRequest;
...
public class SellerTerminalAdminController {
    ...
    public ApiResponse<TchPage<SellerTerminalSummaryRow>> list(
        ...
        var criteria = new SellerTerminalSearchCriteria(q, status, null);
    ...
    @RequiresPermission("terminal.manage")
    ...
    @RequiresPermission("terminal.block")
    ...
    @RequiresPermission("terminal.reset_pin")
