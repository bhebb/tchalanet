...
/**
 * Public effect model consumed by sales. Keep this stable. Internal config can be richer under
 * promotionDecision.internal.
 *
 * <p>Selection generation fields (maryaj-gratis-auto-selection-v1): {@code generationStrategy}
 * applies when {@code choiceMode == AUTO_GENERATE}; V1 supports RANDOM only. {@code
 * regenerableBeforeConfirm} allows the seller to regenerate the generated selection before sale
 * confirmation, capped by {@code maxRegenerationsBeforeConfirm}.
 */
