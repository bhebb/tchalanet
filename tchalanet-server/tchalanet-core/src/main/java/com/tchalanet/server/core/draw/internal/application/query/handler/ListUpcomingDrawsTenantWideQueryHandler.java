...
/**
 * Returns the next upcoming draws for the current tenant across all channels. Used by sales
 * surfaces to embed a list of allowed draws.
 */
@UseCase
...
public class ListUpcomingDrawsTenantWideQueryHandler
  ...
  public List<DrawSummary> handle(ListUpcomingDrawsTenantWideQuery query) {
    ...
    var criteria =
        DrawSearchCriteria.forNext(/* resultSlotId */ null, lookahead, /* limitPerChannel */ limit);
