...
public record DrawSearchCriteria(
  ...
  public static DrawSearchCriteria of(
    ...
    return new DrawSearchCriteria(resultSlotId, parseStatus(status), from, to, null, null, null);
  }

  public static DrawSearchCriteria today(ResultSlotId resultSlotId, LocalDate today) {
    return new DrawSearchCriteria(resultSlotId, null, today, today, null, null, null);
  }
  ...
  public static DrawSearchCriteria upcoming(ResultSlotId resultSlotId, LocalDate today, int days) {
    ...
    return new DrawSearchCriteria(
        resultSlotId, null, today, today.plusDays(days), null, null, null);
  }
  ...
  public static DrawSearchCriteria forNext(
    ...
    return new DrawSearchCriteria(
        resultSlotId, null, null, null, limitPerChannel, lookaheadHours, null);
  }
  ...
  public static DrawSearchCriteria forNextOpen(
    ...
    return new DrawSearchCriteria(
        resultSlotId, DrawStatus.OPEN, null, null, limitPerChannel, lookaheadHours, null);
  }

  public static DrawSearchCriteria forLatestWithResults(List<String> resultSlotKeys) {
    return new DrawSearchCriteria(
        null, null, null, null, null, null, normalizeKeys(resultSlotKeys));
  }
  ...
  public static DrawSearchCriteria forResults(
    ...
    return new DrawSearchCriteria(
        null, DrawStatus.RESULTED, from, to, null, null, normalizeKeys(resultSlotKeys));
  }
