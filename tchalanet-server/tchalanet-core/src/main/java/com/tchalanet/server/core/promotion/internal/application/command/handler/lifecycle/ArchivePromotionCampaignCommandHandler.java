...
public class ArchivePromotionCampaignCommandHandler
    implements CommandHandler<ArchivePromotionCampaignCommand, PromotionCampaignView> {
  ...
  public PromotionCampaignView handle(ArchivePromotionCampaignCommand cmd) {
    ...
    var nextStatus = stateMachine.apply(campaign.status(), PromotionCampaignTransition.ARCHIVE);
