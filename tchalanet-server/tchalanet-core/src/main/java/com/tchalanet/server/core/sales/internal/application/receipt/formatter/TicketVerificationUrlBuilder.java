...
/**
 * Builds the public ticket verification URL printed on QR codes. Points to the public-facing
 * frontend page, never to an internal API path.
 *
 * <p>Example: https://tchalanet.com/public/check-ticket?code=QVQE-NRVR
 */
@Component
