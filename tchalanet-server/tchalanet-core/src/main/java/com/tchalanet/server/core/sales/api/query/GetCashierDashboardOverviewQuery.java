...
/**
 * Returns daily ticket aggregates for the cashier dashboard overview widget. RLS enforces tenant
 * isolation — tenantId is passed for the JDBC session context.
 */
