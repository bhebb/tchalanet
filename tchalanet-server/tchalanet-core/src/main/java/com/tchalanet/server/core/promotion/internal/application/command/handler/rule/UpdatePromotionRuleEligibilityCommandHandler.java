...
public class UpdatePromotionRuleEligibilityCommandHandler implements CommandHandler<UpdatePromotionRuleEligibilityCommand, PromotionCampaignView> {

    private final PromotionCampaignWritePort writePort;
    private final PromotionCacheEvictorPort cacheEvictor;

    @Override
    public PromotionCampaignView handle(UpdatePromotionRuleEligibilityCommand cmd) {
        var out = writePort.updateRuleEligibility(cmd);
