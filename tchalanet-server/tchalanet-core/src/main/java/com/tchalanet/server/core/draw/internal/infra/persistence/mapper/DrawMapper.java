 ...
 *
 * <ul>
 *   <li>Conversion JPA entity → Draw aggregate (toDomain)
 *   <li>Conversion Draw aggregate → JPA entity (toEntity)
 *   <li>Mapping typed IDs ↔ UUID persistence
 *   <li>Gestion des valeurs nullables et defaults (ex: SCHEDULED status)
 * </ul>
 *
...
public class DrawMapper {
  ...
  public Draw toDomain(DrawJpaEntity jpaEntity) {
    ...
    var drawStatus = jpaEntity.getStatus() == null ? DrawStatus.SCHEDULED : jpaEntity.getStatus();

    var drawResultId =
        jpaEntity.getDrawResultId() == null ? null : DrawResultId.of(jpaEntity.getDrawResultId());
  ...
  public void applyToEntity(Draw drawAggregate, DrawJpaEntity jpaEntity) {
    ...
    jpaEntity.setDrawResultId(
        drawAggregate.drawResultId() == null ? null : drawAggregate.drawResultId().value());
