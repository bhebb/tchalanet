...
class ApplyExternalResultsWindowCommandHandlerTest {
    ...
    private static final ResultSlotId SLOT_ID = ResultSlotId.of(UUID.fromString("60000000-0000-0000-0000-000000000001"));
    ...
    private static final DrawResultId DRAW_RESULT_ID = DrawResultId.of(UUID.fromString("50000000-0000-0000-0000-000000000001"));
    ...
    void publishesDrawResultAppliedEventWhenExternalResultIsAttachedToDraw() {
        ...
        var handler = new ApplyExternalResultsWindowCommandHandler(
        ...
        var result = handler.handle(new ApplyExternalResultsWindowCommand(
            TENANT_ID,
        ...
        assertThat(publisher.events().getFirst())
            .isInstanceOfSatisfying(DrawResultAppliedEvent.class, event -> {
    ...
    private static final class SingleSlotCatalog implements ResultSlotCatalog {
        @Override public List<ResultSlotView> listActive() { return List.of(slot()); }
        @Override public Optional<ResultSlotView> findByKey(String slotKey) { return Optional.of(slot()); }
        @Override public ResultSlotView requireByKey(String slotKey) { return slot(); }
        @Override public Optional<ResultSlotView> findById(ResultSlotId id) { return Optional.of(slot()); }
        @Override public boolean existsLive(ResultSlotId id) { return true; }
        @Override public ResultSlotStatsView stats() { throw new UnsupportedOperationException(); }
    ...
    private static final class SingleDrawResultReader implements DrawResultReaderPort {
        @Override public DrawResult getById(DrawResultId id) { throw new UnsupportedOperationException(); }
        @Override public Optional<DrawResultView> findViewById(DrawResultId id) { return Optional.empty(); }
        @Override public Optional<DrawResultView> findViewBySlotKeyAndOccurredAt(String slotKey, Instant occurredAt) { return Optional.empty(); }
        @Override public Optional<DrawResultProjection> findProjectionById(DrawResultId id) { return Optional.empty(); }
        @Override public Optional<DrawResultProjection> findProjectionBySlotKeyAndOccurredAt(String slotKey, Instant occurredAt) { return Optional.empty(); }
        @Override public Optional<DrawResultId> findByResultSlotIdAndOccurredAt(ResultSlotId resultSlotId, Instant occurredAt) { return Optional.of(DRAW_RESULT_ID); }
        @Override public Optional<DrawResultId> findByResultSlotIdAndResultDate(ResultSlotId resultSlotId, LocalDate resultDate) { return Optional.empty(); }
        @Override public TchPage<DrawResultView> findViewsByCriteria(DrawResultsCriteria criteria) { throw new UnsupportedOperationException(); }
        @Override public Optional<DrawResultView> findByDrawId(DrawId drawId) { return Optional.empty(); }
        @Override public boolean existsUsableExternalResult(ResultSlotId resultSlotId, LocalDate resultDate) { return true; }
    }
