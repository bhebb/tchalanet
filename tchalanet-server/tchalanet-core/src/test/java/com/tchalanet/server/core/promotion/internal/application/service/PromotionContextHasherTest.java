...
class PromotionContextHasherTest {
    ...
    void includesSellerTerminalIdInHash() {
        var first = context(SellerTerminalId.of(UUID.fromString("20000000-0000-0000-0000-000000000001")));
        var second = context(SellerTerminalId.of(UUID.fromString("20000000-0000-0000-0000-000000000002")));
