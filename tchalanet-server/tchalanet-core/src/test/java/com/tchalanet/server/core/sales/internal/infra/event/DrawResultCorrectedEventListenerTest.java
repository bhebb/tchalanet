...
@DisplayName("DrawResultCorrectedEventListener")
class DrawResultCorrectedEventListenerTest {

    @Test
    @DisplayName("dispatches reconcile command once")
    void dispatchesOnce() {
        ...
        var dispatched = new java.util.ArrayList<Command<?>>();
        ...
        var listener = new DrawResultCorrectedEventListener(processedEventPort, commandBus);
