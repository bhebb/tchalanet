...
class RecordDrawTicketsResultCommandHandlerTest {
    ...
    private static final SellerTerminalId SELLER_TERMINAL_ID = SellerTerminalId.of(UUID.fromString("91000000-0000-0000-0000-000000000001"));
    ...
    void winningTicketIsSettledPaidAndPublishesRealizedWinningEvents() {
        ...
        assertThat(publisher.events())
            ...
            .hasSize(1)
            .first()
            .satisfies(event -> assertThat(((TicketWinningSettlementCreatedEvent) event).amountCents())
                .isEqualTo(12_500L));
        assertThat(publisher.events())
            .filteredOn(TicketPayoutPaidEvent.class::isInstance)
            .hasSize(1)
            .first()
            .satisfies(event -> assertThat(((TicketPayoutPaidEvent) event).amountCents())
                .isEqualTo(12_500L));
    }
    ...
    private static Ticket ticket(String selection) {
        ...
        return Ticket.place(
            ...
            List.of(TicketLine.customerLine(
    ...
    private static final class CapturingTicketStore implements TicketReaderPort, TicketWriterPort {
        ...
        @Override public List<Ticket> findByDrawId(DrawId drawId) { return List.of(ticket); }
