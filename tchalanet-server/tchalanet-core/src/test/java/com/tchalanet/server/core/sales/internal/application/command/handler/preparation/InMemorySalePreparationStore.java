...
class InMemorySalePreparationStore implements SalePreparationStorePort {
  ...
  public void updateLineSelection(
    ...
    var p = byId.get(preparationId);
    var lines =
        p.promotionLines().stream()
            .map(
                l ->
                    l.lineRef().equals(lineRef)
                        ? new SalePreparationPromotionLine(
                            ...
                            l.betOption(),
                            selection,
                            com.tchalanet.server.core.sales.api.model.promotion
                                .TicketLineSelectionSource.PROMOTION_GENERATED,
                            l.choiceMode(),
                            l.promotionDecisionId(),
                            l.promotionRuleId(),
                            l.promotionRuleKey(),
                            l.promotionEffectType(),
                            l.promotionDecisionContextHash(),
                            l.promotionDecisionEngineVersion(),
                            l.regenerable(),
                            l.maxRegenerations(),
                            regenerationCount)
                        : l)
