...
class PromotionRuleEvaluatorTest {
  ...
  void calculatesQuantityPerPaidAmountStep() {
    var campaignId =
        PromotionCampaignId.of(UUID.fromString("A1000000-0000-0000-0000-000000000002"));
  ...
  void countsRepeatedPaidGameCodes() {
    ...
    var rule =
        new PromotionRule(
            ...
            null,
            List.of(
                new com.tchalanet.server.core.promotion.internal.domain.model
                    .PromotionRuleEligibilityLine("HT_BOLET", 3)),
            List.of(
                new PromotionEffect(
                    ruleId,
                    PromotionEffectType.FREE_GAME_LINE,
  ...
  void calculatesQuantityFromPaidAmountTiers() {
    ...
    assertThat(effects.getFirst().quantityMode())
        .isEqualTo(PromotionQuantityMode.TIERED_PAID_AMOUNT);
  }
                  ...
                  new PromotionEffect(
                      ...
                      List.of(
                          new PromotionQuantityTier(
                              new BigDecimal("200"), new BigDecimal("499"), 2)),
                      new BigDecimal("50"),
                      "HTG",
                      null,
                      null,
