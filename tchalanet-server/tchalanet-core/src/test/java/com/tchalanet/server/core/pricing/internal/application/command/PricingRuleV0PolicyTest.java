...
class PricingRuleV0PolicyTest {
    ...
    void maryajGratisFixedAmount() {
        assertThatCode(() -> PricingRuleV0Policy.validateGameRuleType("HT_MARYAJ_GRATIS", PayoutRuleType.FIXED_AMOUNT))
    ...
    void maryajGratisRejectsMultiplier() {
        assertThatThrownBy(() -> PricingRuleV0Policy.validateGameRuleType("HT_MARYAJ_GRATIS", PayoutRuleType.STAKE_MULTIPLIER))
    ...
    void regularGameMultiplier() {
        assertThatCode(() -> PricingRuleV0Policy.validateGameRuleType("HT_BOLET", PayoutRuleType.STAKE_MULTIPLIER))
            .doesNotThrowAnyException();
    }
    ...
    void regularGameRejectsFixed() {
        assertThatThrownBy(() -> PricingRuleV0Policy.validateGameRuleType("HT_BOLET", PayoutRuleType.FIXED_AMOUNT))
            .isInstanceOf(IllegalArgumentException.class);
    }
}
