...
class PromotionRuleWriteSupportTest {
    ...
    private static final TenantId TENANT = TenantId.of(UUID.fromString("11111111-1111-1111-1111-111111111111"));
    ...
    void updateRuleEffectsPersistsAndReadsCustomMaryajGratisQuantityTiers() {
        ...
        when(effects.save(any(PromotionRuleEffectJpaEntity.class))).thenAnswer(invocation -> invocation.getArgument(0));

        support.updateRuleEffects(new UpdatePromotionRuleEffectsCommand(
            TENANT,
            CAMPAIGN_ID,
            RULE_ID,
