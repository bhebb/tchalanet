...
class MaxStakeExposurePerSelectionPerDrawEvaluatorTest {
  ...
  void supports_the_stake_exposure_rule() {
    assertThat(evaluator.supports()).isEqualTo(RuleKey.MAX_STAKE_EXPOSURE_PER_SELECTION_PER_DRAW);
  }
  ...
  private List<LimitBreach> evaluate(
      long valueCents, LimitFactsSnapshot facts, LimitLineContext... lines) {
