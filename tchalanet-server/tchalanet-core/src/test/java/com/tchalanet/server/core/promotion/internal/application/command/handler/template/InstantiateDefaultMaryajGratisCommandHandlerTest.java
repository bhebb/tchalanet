...
class InstantiateDefaultMaryajGratisCommandHandlerTest {
    ...
    return new InstantiateDefaultMaryajGratisCommandHandler(
        ...
        new PromotionCacheEvictorPort() {
          ...
          public void evictAfterCampaignMutation(
              TenantId tenantId, PromotionCampaignId campaignId) {}
  ...
  void createsAndActivates() {
    ...
    var out = handler(null, writePort).handle(new InstantiateDefaultMaryajGratisCommand(TENANT));
  ...
  void idempotentWhenCodeExists() {
    ...
    var out =
        handler(existing, writePort).handle(new InstantiateDefaultMaryajGratisCommand(TENANT));
            ...
            new InstantiateDefaultMaryajGratisCommand(
                ...
                List.of(
                    new PromotionQuantityTier(
                        new java.math.BigDecimal("100"), new java.math.BigDecimal("199"), 1),
                    new PromotionQuantityTier(
                        new java.math.BigDecimal("200"), new java.math.BigDecimal("499"), 2),
  ...
  private static PromotionCampaignView view(PromotionCampaignStatus status) {
    return new PromotionCampaignView(
        ...
        List.of(
            new PromotionRuleView(
                null,
                "maryaj-gratis-default",
                100,
                List.of(),
                List.of(
                    new PromotionEffectConfigView(
