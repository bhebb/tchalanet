...
class TicketWinningCalculatorTest {
  ...
  class Lotto3 {
    ...
    void exactPlusBoxPaysBestWinningCoverage() {
      ...
      var exactResult =
          calculator.computeLineResults(
              ticket(line, money("20")), projection("123", null, null, null));
      ...
      var permutedResult =
          calculator.computeLineResults(
              ticket(line, money("20")), projection("321", null, null, null));
  ...
  private static TicketLine exactPlusBoxLoto3Line(String played) {
    return new TicketLine(
        ...
        com.tchalanet.server.core.sales.api.model.promotion.TicketLineSelectionSource
            .CUSTOMER_SELECTED,
        null,
        null,
        null,
  ...
  private static DrawResultProjection projection(
      String lot1, String lot2, String lot3, String lot4) {
