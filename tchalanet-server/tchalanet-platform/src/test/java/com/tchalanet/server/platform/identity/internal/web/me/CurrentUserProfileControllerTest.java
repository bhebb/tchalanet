...
class CurrentUserProfileControllerTest {
  ...
  @Mock private CurrentUserProfileService profiles;
  ...
  class GetProfile {
    ...
    void profile_returns_available_surfaces() {
      ...
      var userId = UserId.of(UUID.randomUUID());
      var ctx =
          context(tenantId, userId, UUID.randomUUID().toString(), Set.of(TchRole.TENANT_ADMIN));
  ...
  private static TchRequestContext context(
      TenantId tenantId, UserId userId, String externalSubject) {
