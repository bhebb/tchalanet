...
class TenantThemeAdminServiceTest {
  ...
  void applyPresetSavesNewTheme() {
    when(themeCatalog.findByCode("modern-dark"))
        .thenReturn(Optional.of(activePreset("modern-dark")));
    ...
    assertThatNoException()
        .isThrownBy(() -> service.applyPreset(new ApplyTenantThemeRequest(TENANT, "modern-dark")));
