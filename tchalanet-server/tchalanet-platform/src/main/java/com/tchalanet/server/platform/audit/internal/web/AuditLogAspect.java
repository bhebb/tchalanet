...
public class AuditLogAspect {
  ...
  @Around(
      "@annotation(com.tchalanet.server.platform.audit.api.AuditLog) || @within(com.tchalanet.server.platform.audit.api.AuditLog)")
  ...
  private Object resolveExpressionOrNull(String expr, StandardEvaluationContext ctx, String label) {
    try {
  ...
  private Map<String, Object> normalizeObjectDetails(Object value) {
    try {
      ...
      // Avoid leaking problematic object graphs (can fail with ClassCastException during JSON
      // serialization).
      return Map.of(
          "value",
