...
/**
 * Configuration des flux de notification métier. Contrôle quels événements génèrent des
 * notifications et vers quels canaux.
 */
...
public record NotificationFlowProperties(
  ...
  public record DrawLifecycleFlow(
      boolean enabled, boolean slackInfoEnabled, boolean emailEnabled) {}
  ...
  public record SettlementFlow(
      boolean enabled, boolean slackInfoEnabled, boolean emailAdminEnabled) {}

  public record SalesReportsFlow(boolean enabled, boolean dailyEmailEnabled) {}

  public record ClientDeliveryFlow(
      boolean enabled, boolean ticketSoldEnabled, boolean ticketWonEnabled) {}
}
