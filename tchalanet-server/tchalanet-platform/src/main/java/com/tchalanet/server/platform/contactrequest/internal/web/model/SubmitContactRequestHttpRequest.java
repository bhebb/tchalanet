...
public record SubmitContactRequestHttpRequest(
    @NotNull ContactRequestIntent intent,
    ...
    @Min(0) Integer outletCount,
    @Size(max = 120) String preferredContactTime,
    @NotBlank String message,
    @AssertTrue(message = "Le consentement est requis") boolean consentToContact,
