...
@Table(
    ...
    indexes = {
      @Index(name = "ix_tenant_user_role__tenant_user", columnList = "tenant_id, user_id"),
      @Index(name = "ix_tenant_user_role__role", columnList = "role_id")
    })
@Getter
@Setter
public class TenantUserRoleJpaEntity {
