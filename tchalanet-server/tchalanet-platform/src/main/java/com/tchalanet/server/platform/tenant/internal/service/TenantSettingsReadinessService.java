...
public class TenantSettingsReadinessService {
  ...
  public TenantSettingsReadinessView evaluate(
      TenantRuntimeView runtime, TenantInternalSettings settings) {
    var sections =
        List.of(
            identity(runtime),
            defaults(runtime),
            ...
            calendar(
                settings == null || settings.rules() == null
                    ? null
  ...
  private SectionReadiness defaults(TenantRuntimeView runtime) {
    ...
    if (runtime == null) {
      ...
      var supported =
          runtime.supportedLocales() == null ? List.<String>of() : runtime.supportedLocales();
  ...
  private SectionReadiness sendOptions(
      TenantRuntimeView runtime, TenantInternalCommunicationConfig communication) {
    var missing = new ArrayList<String>();
  ...
  private SectionReadiness section(String section, List<String> blockingReasons) {
    var status =
        blockingReasons.isEmpty() ? ReadinessStatus.READY : ReadinessStatus.ACTION_REQUIRED;
