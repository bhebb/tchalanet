...
public class IdentityUserCrudController {
  ...
  public ApiResponse<List<IdentityUserView>> search(
    ...
    if (unassigned) {
      var results =
          service.searchUnassigned(q, page, size).stream()
              .map(
                  u ->
  ...
  public ApiResponse<IdentityUserView> create(
    ...
    var userId =
        service.createUser(
            request.email(), request.phoneNumber(), names.firstName(), names.lastName());
  ...
  @AuditLog(
      ...
      entity = AuditEntityType.USER,
      idExpression = "#userId")
  public void activate(@CurrentContext TchRequestContext ctx, @PathVariable UUID userId) {
  ...
  @AuditLog(
      ...
      entity = AuditEntityType.USER,
      idExpression = "#userId")
  public void suspend(@CurrentContext TchRequestContext ctx, @PathVariable UUID userId) {
  ...
  @AuditLog(
      ...
      entity = AuditEntityType.USER,
      idExpression = "#userId")
  public void archive(@CurrentContext TchRequestContext ctx, @PathVariable UUID userId) {
  ...
  public ApiResponse<PasswordResetResult> resetPassword(
      @CurrentContext TchRequestContext ctx, @PathVariable UUID userId) {
  ...
  public record AssignMembershipRequest(@NotNull UUID tenantId, @NotBlank String role) {}
