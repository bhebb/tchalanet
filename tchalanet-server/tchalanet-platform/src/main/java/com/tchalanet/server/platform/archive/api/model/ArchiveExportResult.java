 ...
 *
 * <p>Providers return the 2-arg form (rows + schemaVersion). The executor enriches the result with
 * the SHA-256 checksum computed from the {@link
 * com.tchalanet.server.platform.archive.internal.io.JsonlGzWriter} after close.
 */
