...
/**
 * Request to update mutable tenant theme settings. V1: only defaultMode is mutable. Token/font
 * overrides deferred to V2.
 */
public record UpdateTenantThemeSettingsRequest(TenantId tenantId, String defaultMode) {
