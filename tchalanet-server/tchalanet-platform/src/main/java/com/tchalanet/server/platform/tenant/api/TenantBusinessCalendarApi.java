 ...
 *
 * <ol>
 *   <li>business_day_override tenant-level dated exception
 *   <li>TenantBusinessCalendarRules.holidays
 *   <li>TenantBusinessCalendarRules.closedWeekdays
 *   <li>TenantBusinessCalendarRules.defaultOpen
 *   <li>fallback: open
 * </ol>
 *
...
public interface TenantBusinessCalendarApi {
  ...
  TenantBusinessDayView resolveBusinessDay(TenantId tenantId, LocalDate businessDate);
}
