...
public record DocumentOptions(
    Integer qrSizePx, PaperSize paperSize, Boolean compact, EscPosCodePage escPosCodePage) {
  ...
  /**
   * A4 page layout: full-width PDF (595pt), larger QR, not compact. Use for mobile print preview —
   * renders as a readable A4 document, not a narrow receipt strip.
   */
