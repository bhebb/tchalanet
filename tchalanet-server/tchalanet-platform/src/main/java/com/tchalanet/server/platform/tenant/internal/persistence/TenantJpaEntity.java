...
/**
 * JPA entity for TenantConfig. Table: tenant (no RLS, platform registry) Per
 * DOMAIN_TENANT_CONFIG.md: - Platform-wide tenant registry (no RLS needed) - Unique constraint on
 * code - Optional references to address and theme Per typed_ids.md: UUID in entity, typed IDs in
 * domain
 */
@Entity
@Table(name = "tenant")
