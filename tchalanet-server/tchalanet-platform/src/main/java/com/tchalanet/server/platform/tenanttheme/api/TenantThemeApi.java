...
public interface TenantThemeApi {
  ...
  ThemeRuntimeView resolveTenantThemeRuntime(
      com.tchalanet.server.common.types.id.TenantId tenantId, String mode);

  Optional<TenantThemeAdminView> findActiveTenantTheme(
