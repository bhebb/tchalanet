package com.tchalanet.server.platform.entityhistory.internal.listener;

import com.tchalanet.server.common.context.TchContextResolver;
import com.tchalanet.server.common.spring.SpringBeans;
import com.tchalanet.server.platform.entityhistory.internal.persistence.TchRevisionEntity;
...
public class TchRevisionListener implements RevisionListener {
  ...
  public void newRevision(Object revisionEntity) {
    ...
    try {
      ...
      rev.setActorType(ctx.userUuid() == null ? "SYSTEM" : "USER");
