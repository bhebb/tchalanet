...
public class TenantRuntimeController {
  ...
  public ApiResponse<TenantRuntimeView> publicRuntime(@CurrentContext TchRequestContext ctx) {
  ...
  public ApiResponse<TenantRuntimeView> runtime(@CurrentContext TchRequestContext ctx) {
