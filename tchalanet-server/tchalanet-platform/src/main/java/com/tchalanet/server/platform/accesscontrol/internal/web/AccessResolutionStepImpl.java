...
public class AccessResolutionStepImpl implements AccessResolutionStep {
  ...
  static final Set<String> SELLER_TERMINAL_PERMISSIONS =
      Set.of(
  ...
  public void resolve(HttpServletRequest request) {
    ...
    var bootstrappedActor =
        (BootstrappedActor) request.getAttribute(TchContextRequestAttributes.BOOTSTRAPPED_ACTOR);
  ...
  private void enrichSpringAuthentication(ResolvedAccessContext resolved) {
    ...
    log.debug(
        "access.resolved actorType={} roles={} permissions={}",
        resolved.actorType(),
        resolved.roleCodes(),
