...
public record OutboundAttachment(String filename, String contentType, byte[] content) {
  ...
  public static OutboundAttachment fromMetadata(Object raw) {
    ...
    return new OutboundAttachment(filename, contentType, Base64.getDecoder().decode(contentBase64));
  }
}
