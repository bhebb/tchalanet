 ...
 *
 * <p>The {@code payloadJson} parameter must already be a valid JSON string; serialization is the
...
public class ArchiveRestoreAuditLogJdbcRepository {
   ...
   */
  public void insertBatch(UUID restoreRunId, UUID archiveObjectId, List<RestoreAuditRow> rows) {
            ...
            .map(
                r ->
                    new MapSqlParameterSource()
                        ...
                        .addValue(
                            "occurredAt",
                            r.occurredAt() != null ? Timestamp.from(r.occurredAt()) : null)
