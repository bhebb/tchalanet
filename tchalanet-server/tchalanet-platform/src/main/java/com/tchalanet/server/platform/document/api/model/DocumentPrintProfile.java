...
public record DocumentPrintProfile(
  ...
  public static DocumentPrintProfile of(DocumentFormat outputFormat, PaperSize paperSize) {
    ...
    boolean receiptPaper =
        paperSize == PaperSize.RECEIPT_58MM || paperSize == PaperSize.RECEIPT_80MM;

    return new DocumentPrintProfile(outputFormat, paperSize, columns, true, receiptPaper);
  }

  public boolean receiptPaper() {
    return paperSize == PaperSize.RECEIPT_58MM || paperSize == PaperSize.RECEIPT_80MM;
  }
}
