...
/**
 * Evaluates {@code @PreAuthorize("hasPermission(...)")} expressions against the permission set
 * already resolved by {@code AccessResolutionFilter} and stored in {@link
 * TchRequestContext#permissionKeys()}.
 *
