...
@Component
@ConditionalOnProperty(prefix = "tch.identity", name = "provider", havingValue = "local-perf")
public final class LocalPerfIdentityProvider implements IdentityProviderApi {
