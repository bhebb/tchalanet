...
/**
 * Lean port for reading tenant internal settings directly from persistence. Use this instead of
 * TenantConfigApi when you only need the config sub-sections (rules, document, communication)
 * without the full tenant lifecycle view.
 */
