...
class TenantAdminPricingControllerTest {
  ...
  void tenantPricingMutationsAreAudited() throws NoSuchMethodException {
    var upsert =
        TenantAdminPricingController.class
            .getMethod(
                "upsert",
                TenantAdminPricingController.UpsertTenantPricingRuleRequest.class,
    ...
    var delete =
        TenantAdminPricingController.class
            .getMethod(
                "delete",
                TenantAdminPricingController.DeleteTenantPricingRuleRequestBody.class,
                com.tchalanet.server.common.context.TchRequestContext.class)
            .getAnnotation(AuditLog.class);
