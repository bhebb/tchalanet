...
class AdminTicketSettlementServiceTest {
  ...
  void supportedLineResolved() {
    var view =
        service.toLineView(line(GameCode.HT_LOTO4, BetType.LOTTO4_PATTERN, (short) 2, "1234"));
  ...
  void unsupportedLineUnresolved() {
    var view =
        service.toLineView(line(GameCode.HT_LOTO4, BetType.LOTTO4_PATTERN, (short) 99, "1234"));
  ...
  private static TicketPrintLine line(
      GameCode game, BetType betType, Short betOption, String selection) {
