  ...
  public PlatformAdminOverviewView overview() {
    ...
    CatalogStats catalog =
        new CatalogStats(
            ...
            new CountItem(
                i18nKeys.totalKeys(),
                i18nKeys.totalKeys()), // represent as total/active duplication for now
            ...
            new SubscriptionStats(
                ...
                subs == null
                    ...
                    : subs.byPlan().stream()
                        .map(
                            p ->
                                new SubscriptionStats.ByPlanItem(
                                    p.planCode(), p.total(), p.active()))
                        .toList()));
    ...
    PlatformStats platform =
        new PlatformStats(
            ...
            new CountItem(0, 0),
            new CountItem(
                settingsStats.totalGlobalSettings(), settingsStats.totalActiveSettings()));
