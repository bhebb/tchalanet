  ...
  private List<TenantAdminPoliciesOverviewView.ScopeCard> scopeCards(
    ...
    return List.of(
        new TenantAdminPoliciesOverviewView.ScopeCard(
            ...
            "tune",
            "Globales",
            "Limites appliquées à toutes les ventes du tenant.",
        ...
        new TenantAdminPoliciesOverviewView.ScopeCard(
            ...
            "storefront",
            "Vendeurs",
            "Overrides appliqués à un terminal ou à un vendeur précis.",
            "Par vendeur",
            "À surveiller",
            "seller-terminal",
            "Voir"),
        new TenantAdminPoliciesOverviewView.ScopeCard(
            ...
            "pin",
            "Numéros",
            "Règles qui limitent l’exposition sur une sélection.",
  ...
  private List<TenantAdminPoliciesOverviewView.ActionLink> actionLinks() {
    return List.of(
        new TenantAdminPoliciesOverviewView.ActionLink(
            ...
            "block",
            "Bloquer un numéro",
            "Fermer une sélection trop jouée ou à risque pour un tirage.",
            "number"),
        new TenantAdminPoliciesOverviewView.ActionLink(
            "draw-limit",
            "event",
            "Limiter un tirage",
            "Appliquer une limite spécifique à un canal de tirage.",
            "draw"),
        new TenantAdminPoliciesOverviewView.ActionLink(
            "seller-limit",
            "storefront",
