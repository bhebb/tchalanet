...
public class PosHomeService {
  ...
  private PosHomeResponse sellerTerminalHome(
    ...
    var terminal =
        queryBus.ask(new GetSellerTerminalQuery(ctx.effectiveTenantIdRequired(), sellerTerminalId));
    ...
    var operationalCtx =
        new PosHomeOperationalContext(
            canSell && requiredStep == null,
            true,
            "SELLER_TERMINAL",
            sellerTerminalId,
