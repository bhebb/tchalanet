package com.tchalanet.server.features.runtime.web;

import com.tchalanet.server.common.context.TchRequestContext;
import com.tchalanet.server.common.context.web.CurrentContext;
import com.tchalanet.server.common.web.api.ApiResponse;
import com.tchalanet.server.features.runtime.app.RuntimeBootstrapService;
...
public class RuntimeController {
    ...
    @GetMapping("/tenant/runtime/bootstrap")
    @PreAuthorize("hasAnyRole('SUPER_ADMIN', 'TENANT_ADMIN', 'CASHIER', 'OPERATOR')")
    @Operation(summary = "Private runtime bootstrap — resolves space, theme, i18n, entitlements and pageModelRef from JWT context")
