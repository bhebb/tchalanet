...
import com.tchalanet.server.features.cashier.print.PrintDeliveryOption;
...
public class TicketPrintCommunicationMapper {
    ...
    private boolean supportsAttachment(CommunicationChannel channel) {
        // WhatsApp document/media support is provider-dependent.
        // Keep enabled for now because the selected provider is expected to support it.
    ...
    private String subject(TicketPrintView view) {
        // TODO(v1.5): move subject rendering to platform.communication templates.
        return "Ticket Tchalanet " + view.identity().ticketCode();
    }

    private String message(TicketPrintView view) {
        // TODO(v1.5): move body rendering to platform.communication templates + i18n.
        return """
