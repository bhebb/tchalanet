...
public class DrawCalendarOpsController {
  ...
  public ApiResponse<TchPage<DrawOpsResponse>> list(
    ...
    var criteria = DrawSearchCriteria.of(null, status, from, to).withResultSlotKey(resultSlotKey);
  ...
  public ApiResponse<OpsLaunchResponse> generate(@Valid @RequestBody GenerateDrawsRequest req) {
    return ApiResponse.success(
        batchLaunchFacade.launchForTenants(
            DRAW_GENERATE,
            req.tenantCodes(),
            tenantId ->
                params(
  ...
  @AuditLog(
      ...
      detailsExpression = "#req")
  public ApiResponse<OpsLaunchResponse> openToday(@Valid @RequestBody OpenTodayDrawsRequest req) {
    return ApiResponse.success(
        batchLaunchFacade.launchForTenants(
            DRAW_OPEN,
            req.tenantCodes(),
  ...
  @AuditLog(
      ...
      detailsExpression = "#req")
  public ApiResponse<OpsLaunchResponse> closeDue(@Valid @RequestBody CloseDueDrawsRequest req) {
    return ApiResponse.success(
        batchLaunchFacade.launchForTenants(
            DRAW_CLOSE,
            req.tenantCodes(),
