...
/**
 * Ops controller for batch job management. NOTE: /api/v1 prefix is added automatically by platform
 * config. Endpoints: - GET /platform/ops/batchzxx/jobs - GET /platform/ops/batch/jobs/{jobKey} -
...
public class OpsBatchJobController {
  ...
  public ApiResponse<StartJobResponse> startJob(
      @PathVariable String jobKey, @Valid @RequestBody StartJobRequest request) {
