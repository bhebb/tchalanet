 ...
 *
 * <p>Public rule: - Resolves public PageModels only. - Returns 404 for private/non-public
 * documents. - Does not use authenticated admin/cashier tenant context as public tenant source.
 */
@Service
