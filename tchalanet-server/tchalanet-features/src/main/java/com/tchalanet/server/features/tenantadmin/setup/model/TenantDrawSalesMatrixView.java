...
public record TenantDrawSalesMatrixView(MatrixSummary summary, List<ProviderMatrixView> providers) {
  ...
  public record ProviderMatrixView(String providerCode, List<SlotMatrixView> slots) {}
  ...
  public record LimitsSetupView(boolean configured, List<LimitAssignmentRow> assignments) {}

  public record LimitAssignmentRow(
      RuleKey ruleKey, boolean enabled, BreachOutcome onBreach, JsonNode params) {}
