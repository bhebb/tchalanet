...
public record TenantGamesPricingView(List<GamePricingRow> games) {
  ...
  public record LimitsView(boolean configured, List<LimitAssignmentRow> assignments) {}

  public record LimitAssignmentRow(
      RuleKey ruleKey, boolean enabled, BreachOutcome onBreach, JsonNode params) {}

  public record PricingView(boolean configured, List<PricingEntryRow> entries) {}
