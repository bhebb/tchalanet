 ...
 * [harden-pagemodel-security-v2 / D2] Le client demande GET /tenant/dashboard ; le serveur résout
 * le logicalId concret depuis TchRequestContext (rôle). Aucun logicalId arbitraire accepté.
 */
@RestController
