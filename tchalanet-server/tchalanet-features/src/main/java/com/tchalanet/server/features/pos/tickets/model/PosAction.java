...
public record PosAction(
    PosActionType type, String labelKey, boolean enabled, Map<String, Object> params) {
  public PosAction {
  ...
  public static PosAction disabled(
      PosActionType type, String labelKey, Map<String, Object> params) {
