 ...
 *
 * <p>Uses {@code items} (matching the shell fragment JSON schema) rather than {@code destinations}
 * to stay consistent with what the frontend receives from JSON file fragments.
 */
public record NavigationSection(
  ...
  public static NavigationSection of(String id, String labelKey, List<NavigationEntry> items) {
