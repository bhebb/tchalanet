 ...
 *
 * <p>V1 supports three profiles. {@code CUSTOM_FROM_TENANT} is explicitly out of V1.
 *
 * <p>Note: this profile is orthogonal to {@code catalog.tenant.TenantType} (BORLETTE / RESEAU /
 * AMBULANT) — TenantType classifies the running business, the profile describes how the tenant is
 * seeded at provisioning time only.
 */
