 ...
 *
 * <p>Served by {@code JsonFileProvider} from {@code public_header_links.json}. This record is the
 * typed Java representation of that fragment.
 *
 * <p>Per {@code harden-pagemodel-security-v2} D1: public headers MUST NOT expose private routes or
