 ...
 *
 * <p>Construit la clé i18n à partir du slotKey selon le format : {@code
 * draw_channel.{provider}.{period}.label}
 *
 * <p>Exemples :
 *
 * <ul>
 *   <li>NY_MID → draw_channel.ny.mid.label
 *   <li>FL_EVE → draw_channel.fl.eve.label
 *   <li>TX_1800 → draw_channel.tx.1800.label
 * </ul>
 *
 * <p>Cette classe évite d'avoir à stocker les label_key dans la BD et permet une construction
 * dynamique cohérente côté backend.
 */
