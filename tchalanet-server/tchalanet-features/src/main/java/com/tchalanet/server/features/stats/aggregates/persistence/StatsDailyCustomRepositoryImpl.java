...
public class StatsDailyCustomRepositoryImpl implements StatsDailyCustomRepository {
  ...
  public void upsertAndIncrement(
    ...
    String sql =
        "INSERT INTO stats_daily (id, dimension_type, dimension_id, ref_date, tickets_count, tickets_cancelled_count, stake_sum_cents, winnings_sum_cents, net_revenue_cents, payouts_count, sessions_opened_count, sessions_closed_count, created_at, updated_at) "
