...
import com.tchalanet.server.catalog.billing.application.command.model.ResumeSubscriptionCommand;
...
public class ResumeSubscriptionCommandHandler
  ...
  public Subscription handle(ResumeSubscriptionCommand command) {
    ...
    billingProvider.resume(new BillingParams(command.tenantId(), saved.id()));
