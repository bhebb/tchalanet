...
import com.tchalanet.server.catalog.billing.domain.exception.SubscriptionAlreadyCanceledException;
import com.tchalanet.server.catalog.billing.domain.exception.SubscriptionCannotBeCanceledException;
import com.tchalanet.server.catalog.billing.domain.exception.SubscriptionCannotBeResumedException;
import com.tchalanet.server.catalog.billing.domain.exception.SubscriptionCannotBeSuspendedException;
...
public record Subscription(
  ...
  public Subscription suspend(Instant now) {
    if (status != SubscriptionStatus.ACTIVE) {
      throw new SubscriptionCannotBeSuspendedException(
          SubscriptionId.nullableOf(id.value()), status);
    }
  ...
  public Subscription updateBilling(
