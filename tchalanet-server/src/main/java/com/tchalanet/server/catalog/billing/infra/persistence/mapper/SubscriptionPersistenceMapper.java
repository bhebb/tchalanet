package com.tchalanet.server.catalog.billing.infra.persistence.mapper;
...
public interface SubscriptionPersistenceMapper {
  ...
  @Mapping(
      target = "planId",
      expression = "java(mapPlanId(e.getPlan() == null ? null : e.getPlan().getId()))")
  ...
  default SubscriptionStatus mapStatus(Object s) {
