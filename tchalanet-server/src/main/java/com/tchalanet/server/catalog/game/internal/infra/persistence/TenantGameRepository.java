...
import com.tchalanet.server.catalog.game.internal.infra.persistence.read.TenantGameView;
...
public interface TenantGameRepository extends JpaRepository<TenantGameJpaEntity, UUID> {
  ...
  Optional<TenantGameView> findTenantGameViewByGameId(UUID gameId);

  Optional<TenantGameJpaEntity> findByGameId(UUID gameId);
}
