package com.tchalanet.server.catalog.pricing.internal.admin;
...
public class PricingAdminService {
  ...
  public PricingOddsEntity create(CreatePricingOddsRequest req) {
    ...
    // tenant handling: BaseTenantEntity expects tenantId UUID
  ...
  private static void apply(BasePricingOddsRequest req, PricingOddsEntity e) {
  ...
  public record CreatePricingOddsRequest(
      ...
      java.math.BigDecimal odds,
      Boolean active
  ) implements BasePricingOddsRequest {}
