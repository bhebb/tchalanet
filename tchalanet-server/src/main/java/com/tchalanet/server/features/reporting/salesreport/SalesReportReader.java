...
public class SalesReportReader {
  ...
  public List<SalesReportLine> findSalesByPeriodAndGame(SalesReportCriteria criteria) {
    var fromDate = criteria.fromDate();
    var toExclusive = criteria.toDate().plusDays(1);
    ...
    query.setParameter("gameCode", criteria.gameCode());
