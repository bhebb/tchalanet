...
public class GetTenantKpisController {
    ...
    private GetTenantKpisQuery buildGetTenantKpisQuery(KpisRange range, LocalDate from, LocalDate to) {
        ...
        return new GetTenantKpisQuery(
            contextHolder.get().tenantUuid(),
            fromDate,
            toDate
        );
    }
