...
/**
 * Modèle de page déclaratif tel que stocké dans la colonne JSONB `model`.
 * Ce record est partagé par toutes les features (admin, publichome, private_dashboard).
 */
