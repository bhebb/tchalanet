...
public class CashierDashboardService {
  ...
  private CashierOverviewBlock buildOverview(
    ...
    try {
      ...
      if (outletLine != null) {
        outletSummary =
            new com.tchalanet.server.features.private_dashboard.block.OutletSummaryDto(
                outletLine.outletId(),
        ...
        outletSummary =
            com.tchalanet.server.features.private_dashboard.block.OutletSummaryDto.empty();
      }
