...
public class CashierDashboardService {
    ...
    private CashierOverviewBlock buildOverview(TenantId tenantId, UserId userId, @SuppressWarnings("unused") String currentLang) {
        try {
            ...
            if (outletLine != null) {
                outletSummary = new com.tchalanet.server.features.private_dashboard.block.OutletSummaryDto(
                    outletLine.outletId(),
                ...
                outletSummary = com.tchalanet.server.features.private_dashboard.block.OutletSummaryDto.empty();
            }
