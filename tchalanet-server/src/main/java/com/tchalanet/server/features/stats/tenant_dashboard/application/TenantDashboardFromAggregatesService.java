...
public class TenantDashboardFromAggregatesService {
    ...
    public TenantDashboardStatsResponse compute(TenantDashboardStatsQuery query) {
        ...
        for (StatsDailyEntity r : rows) {
            ...
            dailyPoints.add(new TenantDailySalesPointDto(
                    r.getRefDate(),
        ...
        TenantSummaryCardDto summary = new TenantSummaryCardDto(
                totalTickets,
        ...
        TenantDashboardStatsDto dto = new TenantDashboardStatsDto(
                from,
                to,
                summary,
                gameBreakdown,
