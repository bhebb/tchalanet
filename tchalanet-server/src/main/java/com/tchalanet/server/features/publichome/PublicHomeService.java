...
public class PublicHomeService {
    ...
    public ApiResponse<PublicHomeResponse> getPublicHome(Optional<String> langFromUrl) {
        ...
        try {
            ...
            notices = List.of(new ApiNotice("SERVICE_DEGRADED", "Some content may be unavailable", "publichome", NoticeSeverity.WARN, Map.of()));
        }
        ...
        var response = new PublicHomeResponse(
            currentLang,
            langs,
            pageModel,
            dynamic,
