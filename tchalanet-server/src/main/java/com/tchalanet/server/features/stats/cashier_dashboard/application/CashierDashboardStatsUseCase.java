...
public class CashierDashboardStatsUseCase {
  ...
  public CashierDashboardStatsResponse handle(CashierDashboardStatsQuery query) {
    ...
    CashierInfoProjection info =
        cashierReadRepository
            .findInfoById(tenantId, cashierId)
            .orElseGet(
                () -> new CashierInfoProjection(cashierId, "Cashier " + cashierId, null, null));

    boolean hasOpenSession = cashierSessionReadRepository.hasOpenSession(tenantId, cashierId);

    CashierSummaryCardDto summary =
        new CashierSummaryCardDto(
            info.cashierId(),
            info.cashierName(),
            info.outletId(),
            info.outletName(),
