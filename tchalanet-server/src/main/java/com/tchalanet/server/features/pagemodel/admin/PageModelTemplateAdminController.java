...
public class PageModelTemplateAdminController {
    ...
    public ResponseEntity<PageModelTemplateResponse> create(
        ...
        PageModelTemplateEntity created = service.create(mapper.toEntity(req), userId == null ? null : userId.uuid());
    ...
    public ResponseEntity<PageModelTemplateResponse> update(
        ...
        try {
            PageModelTemplateEntity updated = propagate
                ? service.updateAndPropagate(id, mapper.toEntity(dto), userId == null ? null : userId.uuid(), true)
    ...
    public ResponseEntity<PageModelTemplateResponse> setDefault(
        ...
        try {
            PageModelTemplateEntity updated = service.setDefault(id, userId == null ? null : userId.uuid());
            return ResponseEntity.ok(mapper.toResponse(updated));
        } catch (IllegalArgumentException ex) {
            return ResponseEntity.notFound().build();
        }
