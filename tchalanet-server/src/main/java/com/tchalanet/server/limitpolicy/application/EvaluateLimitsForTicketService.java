package com.tchalanet.server.limitpolicy.application;
...
import com.tchalanet.server.limitpolicy.domain.ports.out.GameReadModelPort;
...
public class EvaluateLimitsForTicketService implements EvaluateLimitsForTicketUseCase {
