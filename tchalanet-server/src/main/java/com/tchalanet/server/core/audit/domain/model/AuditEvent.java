...
/**
 * Domaine pur: append-only audit event.
 * - id nullable (avant persistence)
 * - tenantId nullable (cas SYSTEM global)
 */
public final class AuditEvent {
    ...
    public static AuditEvent now(
        ...
        return of(tenantId, Instant.now(), actorType, actorId, entityType, entityId, action, detailsJson, ip, userAgent);
    }
