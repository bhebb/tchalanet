package com.tchalanet.server.core.outlet.config;
  ...
  public CacheSpecProvider outletCacheSpecProvider() {
    return () ->
        List.of(
            ...
            new CacheSpec("tenant_outlet", Duration.ofMinutes(20)),
            // Config terminal : idem
            new CacheSpec("tenant_terminal", Duration.ofMinutes(20)),
            // Arbre complet outlets/terminaux : 5–15 min, v1 = 10 min
            new CacheSpec("tenant_outlet_tree", Duration.ofMinutes(10))
        );
  }
}
