...
@Slf4j
public class GenerateDrawsForRangeCommandHandler implements CommandHandler<GenerateDrawsForRangeCommand, GenerateDrawsForRangeResult> {
    ...
    private Acc generateRows(
        ...
        java.util.List<DrawChannelCalendarRow> channels) {
        int skipped = 0;
        int alreadyExists = 0;
