        ...
        chunks.getItems()
            .forEach(row -> {
                ...
                try {
                    ...
                    log.error("ApplyResultWriter: failed to save result for draw={} cause={}", row.drawId(), e.getMessage());
                    return;
                }
                ...
                try {
                    ...
                    log.error("ApplyResultWriter: failed to update draw status for draw={} cause={}", row.drawId(), e.getMessage());
                }
            });
    }
}
