...
public interface DrawSalesGuardPort {
   ...
   * @throws com.tchalanet.server.common.error.ProblemRest si l'annulation est bloquée
   */
   ...
   * @throws com.tchalanet.server.common.error.ProblemRest si l'archivage est bloqué
   */
   ...
   * @throws com.tchalanet.server.common.error.ProblemRest si la correction est bloquée
   */
