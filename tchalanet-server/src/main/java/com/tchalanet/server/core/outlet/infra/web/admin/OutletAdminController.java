...
public class OutletAdminController {
    ...
    public ResponseEntity<Void> updateConfig(@PathVariable OutletId id,
    ...
    public ResponseEntity<Void> closeDay(@PathVariable OutletId id,
                                         @RequestHeader("X-Tenant-Id") TenantId tenantId,
        ...
        CloseOutletDayPayload payload = new CloseOutletDayPayload(r.fromOrNow(), r.toOrNow(), r.modeOrDefault(), r.reason());
    ...
    public ResponseEntity<Void> reopenDay(@PathVariable OutletId id,
                                          @RequestHeader("X-Tenant-Id") TenantId tenantId) {
    ...
    public ResponseEntity<OutletDailySummary> dailySummary(@PathVariable OutletId id,
                                                            @RequestHeader("X-Tenant-Id") TenantId tenantId,
    ...
    public ResponseEntity<String> generateReport(@PathVariable OutletId id,
                                                 @RequestHeader("X-Tenant-Id") TenantId tenantId,
    ...
    public ResponseEntity<Resource> downloadReport(@PathVariable OutletId id,
                                                   @RequestHeader("X-Tenant-Id") TenantId tenantId,
                                                   @RequestParam("date") String date) {
        LocalDate d;
        try {
