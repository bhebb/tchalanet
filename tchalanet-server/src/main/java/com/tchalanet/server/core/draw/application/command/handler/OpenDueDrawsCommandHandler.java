...
@Slf4j
@Validated
public class OpenDueDrawsCommandHandler implements CommandHandler<OpenDueDrawsCommand, OpenDueDrawsResult> {
    ...
    public OpenDueDrawsResult handle(@Valid OpenDueDrawsCommand command) {
        ...
        log.info(
            "openDueDraws now={} opened={} skippedLocked={}",
            command.now(),
            opened,
            skippedLocked);
