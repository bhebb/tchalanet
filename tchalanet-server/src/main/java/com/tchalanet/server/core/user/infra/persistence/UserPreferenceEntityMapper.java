...
class UserPreferenceEntityMapper {
  ...
  com.tchalanet.server.core.user.domain.model.UserPreference toDomain(
      UserPreferenceJpaEntity entity) {
    if (entity == null) return null;
    com.tchalanet.server.core.user.domain.model.UserPreference pref =
        new com.tchalanet.server.core.user.domain.model.UserPreference();
  ...
  UserPreferenceJpaEntity toEntity(
      com.tchalanet.server.core.user.domain.model.UserPreference domain) {
