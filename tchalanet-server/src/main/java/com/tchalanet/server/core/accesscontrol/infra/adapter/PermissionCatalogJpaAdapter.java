package com.tchalanet.server.core.accesscontrol.infra.adapter;

import com.tchalanet.server.core.accesscontrol.infra.persistence.PermissionHierarchyJpaRepository;
...
public class PermissionCatalogJpaAdapter
    implements com.tchalanet.server.core.accesscontrol.application.port.out.PermissionCatalogPort {
