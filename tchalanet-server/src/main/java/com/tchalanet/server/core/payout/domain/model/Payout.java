...
public class Payout {
    ...
    public void markPaid(Instant when, boolean allowFromRequested) {
        ...
        throw new IllegalStateException(
            "PAID allowed only from APPROVED" + (allowFromRequested ? " or REQUESTED" : "") + ". status=" + status
        );
    }
     ...
     * <p>
     * Rules (V1):
     * - Only REQUESTED can be rejected (keep it strict).
     * - Requires a timestamp; reason optional but recommended.
     */
