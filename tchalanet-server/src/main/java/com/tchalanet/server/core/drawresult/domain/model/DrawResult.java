 ...
 *
 * <p>Unicité: (provider, provider_slot, occurred_at). Contient le résultat source normalisé + la
 * projection haïtienne (lot1..lot4).
 */
public record DrawResult(
    String provider, // NY/FL/GA/TN
    String providerSlot, // MID/EVE (ou PICK3_MID etc. si tu choisis)
