...
public class LimitFactsRepositoryAdapter implements LimitFactsProvider {
  ...
  @Override
  public SelectionExposure getSelectionExposure(
      TenantId tenantId,
      DrawId drawId,
      ScopeType scopeType,
      UUID scopeId,
    ...
    return new SelectionExposure(
        drawExposureJpaEntity.getStakeTotal(),
        drawExposureJpaEntity.getSalesCount(),
        drawExposureJpaEntity.getPotentialPayoutTotal());
  }
  ...
  public DailyTotals getDailyTotals(
      TenantId tenantId, LocalDate day, ScopeType scopeType, UUID scopeId) {
