...
public final class AppUser {
    ...
    public static AppUser restore(
        ...
        return new AppUser(
            id, keycloakId, tenantId, tenantCode, username, email, phone,
            firstName, lastName, displayName, avatarUrl, locale, timeZone,
            status, approvedAt, approvedBy, lastLoginAt, version
        );
    }
