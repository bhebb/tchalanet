...
public final class AutonomyResolver {
  ...
  public ResolvedAutonomy resolve(
      TenantId tenantId, AgentId agentId, TerminalId terminalId, OutletId outletId, Instant now) {
    ...
    var p =
        repo.findActive(tenantId, AutonomyTargetType.AGENT, agentUuid, now)
