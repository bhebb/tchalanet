...
import com.tchalanet.server.user.domain.usecase.UpdateUserPreferenceUseCaseImpl;
import com.tchalanet.server.user.web.dto.UpdateUserPreferenceRequest;
import com.tchalanet.server.user.web.dto.UserPreferenceResponse;
