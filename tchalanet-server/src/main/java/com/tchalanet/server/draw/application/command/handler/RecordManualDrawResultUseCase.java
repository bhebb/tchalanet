...
import com.tchalanet.server.draw.application.command.model.RecordManualDrawResultCommand;
import com.tchalanet.server.draw.application.port.in.command.RecordManualDrawResultCommandHandler;
