...
import com.tchalanet.server.draw.application.port.in.command.SettleDrawsCommandHandler;
...
@Slf4j
public class SettleDrawsUseCase implements SettleDrawsCommandHandler {
