...
import com.tchalanet.server.draw.infra.persistence.DrawResultJpaRepository;
import com.tchalanet.server.draw.infra.persistence.mapper.DrawResultMapper;
...
public class DrawResultJpaRepositoryAdapter implements DrawResultReaderPort, DrawResultWriterPort {
  ...
  public java.util.List<DrawResult> findByCriteria(
      com.tchalanet.server.draw.application.query.model.DrawResultsSearchCriteria criteria) {
    return java.util.List.of();
  }
  ...
  public DrawResult overrideResult(
      DrawResult result,
      com.tchalanet.server.draw.application.query.model.DrawResultOverrideMetadata metadata) {
