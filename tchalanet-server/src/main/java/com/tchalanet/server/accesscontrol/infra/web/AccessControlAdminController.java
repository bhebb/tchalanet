package com.tchalanet.server.accesscontrol.infra.web;

import com.tchalanet.server.accesscontrol.application.annotation.RequiresPermission;
import com.tchalanet.server.accesscontrol.application.port.in.PermissionAdminUseCase;
import com.tchalanet.server.accesscontrol.application.port.in.RoleAdminUseCase;
import com.tchalanet.server.accesscontrol.infra.web.dto.PermissionResponse;
import com.tchalanet.server.accesscontrol.infra.web.dto.RoleAdminResponse;
import com.tchalanet.server.accesscontrol.infra.web.dto.UpdateRolePermissionsRequest;
import com.tchalanet.server.accesscontrol.infra.web.dto.UpsertRoleRequest;
import com.tchalanet.server.accesscontrol.infra.web.mapper.AccessControlWebMapper;
