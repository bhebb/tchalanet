...
/**
 * Request-scoped context for collecting API response notices and service statuses.
 * Uses ThreadLocal to maintain state per HTTP request.
 */
public class ApiResponseContext {

    private static final ThreadLocal<ApiResponseContext> CONTEXT = ThreadLocal.withInitial(ApiResponseContext::new);
