package com.tchalanet.server.tenantconfig.infra.persistence.adapter;

import com.tchalanet.server.tenantconfig.domain.model.TenantSetting;
import com.tchalanet.server.tenantconfig.domain.ports.out.TenantConfigRepositoryPort;
import com.tchalanet.server.tenantconfig.infra.persistence.entity.TenantSettingEntity;
import com.tchalanet.server.tenantconfig.infra.persistence.mapper.TenantSettingMapper;
import com.tchalanet.server.tenantconfig.infra.persistence.repository.SpringTenantSettingJpaRepository;
