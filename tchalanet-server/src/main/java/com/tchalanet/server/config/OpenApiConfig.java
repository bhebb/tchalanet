...
@SecurityScheme(
        ...
        flows = @io.swagger.v3.oas.annotations.security.OAuthFlows(
                authorizationCode = @io.swagger.v3.oas.annotations.security.OAuthFlow(
                        ...
                        scopes = {
                                @io.swagger.v3.oas.annotations.security.OAuthScope(name = "openid", description = "OpenID"),
                                @io.swagger.v3.oas.annotations.security.OAuthScope(name = "profile", description = "Profile"),
                                @io.swagger.v3.oas.annotations.security.OAuthScope(name = "email", description = "Email")
                        }
                )
        )
)
