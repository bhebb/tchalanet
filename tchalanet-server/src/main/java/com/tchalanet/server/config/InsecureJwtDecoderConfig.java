...
/**
 * Profil local "insecure" pour simplifier le dev quand les certificats changent souvent.
 * NE PAS UTILISER EN PROD NI EN PREPROD.
 */
@Configuration
@Profile("insecure")
    ...
    TrustManager[] trustAll =
        new TrustManager[] {
          new X509TrustManager() {
            ...
            // Elles ne doivent jamais être modifiées pour de la logique métier ni utilisées en prod.
