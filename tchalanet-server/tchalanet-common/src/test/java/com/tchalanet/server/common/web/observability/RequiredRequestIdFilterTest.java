...
class RequiredRequestIdFilterTest {
  ...
  private static final TchObservabilityProperties PROPERTIES =
      new TchObservabilityProperties(
          true,
  ...
  void missingHeaderProblemDetailContainsServerRequestId() throws Exception {
    ...
    assertThat(res.getContentAsString()).contains("requestId").contains("srv_req_");
  }
