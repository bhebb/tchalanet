...
class NeutralContextContractsTest {
    ...
    void sellerTerminalFactory_setsCorrectFields() {
      var actor =
          BootstrappedActor.sellerTerminal(
              TERMINAL_ID, TENANT_ID, "firebase", "https://issuer", "sub-456");
  ...
  class ResolvedAccessContextContracts {
    ...
    void nullSetsComeOutAsEmptyImmutableSets() {
      var ctx =
          new ResolvedAccessContext(
              TchActorType.APP_USER, USER_ID, null, null, false, false, null, null);
    ...
    void setsAreDefensivelyImmutable() {
      ...
      var ctx =
          new ResolvedAccessContext(
              TchActorType.APP_USER, USER_ID, null, null, false, false, mutableRoles, Set.of());
  ...
  class TchRequestContextNewFields {
    ...
    void withResolvedAccess_setsActorFields() {
      ...
      var updated =
          base.withResolvedAccess(
              TchActorType.APP_USER, null, Set.of("TENANT_ADMIN"), Set.of("tenant.manage"));
    ...
    private static class ContextBuilder {
      TchRequestContext build() {
        return new TchRequestContext(
            ...
            null,
            "active",
            com.tchalanet.server.common.context.scope.ApiScope.TENANT,
            null,
            TENANT_ID,
