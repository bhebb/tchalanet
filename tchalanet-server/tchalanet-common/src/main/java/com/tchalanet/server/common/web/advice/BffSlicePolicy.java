...
public record BffSlicePolicy<T>(
  ...
  public static <T> BffSlicePolicy<T> warn(
      String code, String message, String domain, NoticeSource source, Supplier<T> fallback) {
    return new BffSlicePolicy<>(
        code, message, domain, source, NoticeSeverity.WARN, null, null, fallback);
  }

  public static <T> BffSlicePolicy<T> warn(
      String code, String message, String domain, NoticeSource source, T fallback) {
  ...
  public static <T> BffSlicePolicy<T> error(
      String code, String message, String domain, NoticeSource source, Supplier<T> fallback) {
    return new BffSlicePolicy<>(
        code, message, domain, source, NoticeSeverity.ERROR, null, null, fallback);
  }
