...
/**
 * Minimal tenant defaults used by the execution context. Keep this small: identity + formatting
 * defaults (currency, timezone).
 */
public record TenantContextInfo(
    TenantId tenantId, String tenantCode, Currency currency, ZoneId tenantZoneId) {
