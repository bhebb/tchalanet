...
public class JsonUtils {
   ...
   *
   * <p>- JsonNode → returned as-is - String → parsed (NOT TextNode) - Object → valueToTree
   */
  ...
  /**
   * A fresh empty JSON object. Static so value objects / record compact constructors can use it (no
   * Spring bean available there). Single place to change if the Jackson node contract evolves.
   */
