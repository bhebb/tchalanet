 ...
 *
 * <ul>
 *   <li>{@code HIGHEST_PRECEDENCE + 5} — RequiredRequestIdFilter (validate + MDC)
 *   <li>{@code HIGHEST_PRECEDENCE + 7} — ServletExceptionBridgeFilter (filter exceptions)
 *   <li>{@code HIGHEST_PRECEDENCE + 10} — TraceResponseHeaderFilter (response headers)
 *   <li>Spring Security at -100
 *   <li>BearerTokenAuthenticationFilter, IdentityBootstrapFilter, TchContextFilter inside Security
 * </ul>
 */
@Configuration
