 ...
 *
 * <p>MDC keys {@code traceId} and {@code spanId} are populated automatically by Micrometer Tracing
 * once the OTel bridge is configured (B3 slice). At B1 they return null gracefully, which is the
