...
public class CommonIdMapper {
  ...
  // SellerTerminalId
  public UUID mapFromSellerTerminalId(SellerTerminalId id) {
    return id == null ? null : id.value();
  }

  public SellerTerminalId mapToSellerTerminalId(UUID id) {
    return SellerTerminalId.nullableOf(id);
  }
  ...
  public com.tchalanet.server.common.types.id.BusinessDayOverrideId mapToBusinessDayOverrideId(
      UUID id) {
  ...
  public com.tchalanet.server.common.types.id.ResultSlotCalendarOverrideId
      mapToResultSlotCalendarOverrideId(UUID id) {
