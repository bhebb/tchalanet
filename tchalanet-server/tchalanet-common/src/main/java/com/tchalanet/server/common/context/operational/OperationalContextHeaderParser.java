...
public final class OperationalContextHeaderParser {
  ...
  public static OperationalContextHint parseHint(HeaderReader headers) {
    var declaredSource =
        resolveSource(header(headers, OperationalContextHeaders.OPERATIONAL_SOURCE));
  ...
  private static OperationalContextSource deriveSource(OperationalContextSource declaredSource) {
