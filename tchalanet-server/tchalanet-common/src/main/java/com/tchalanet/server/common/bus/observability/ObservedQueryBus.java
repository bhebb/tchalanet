 ...
 *
 * <p>Fail-open: noop ObservationRegistry produces no spans. Does not reference SimpleQueryBus
 * directly.
 */
@Slf4j
public class ObservedQueryBus implements QueryBus {
  ...
  public ObservedQueryBus(QueryBus delegate, ObservationRegistry registry, Set<String> allowlist) {
  ...
  public <R> R ask(Query<R> query) {
    ...
    var observation =
        Observation.createNotStarted("tch.query." + name, registry)
