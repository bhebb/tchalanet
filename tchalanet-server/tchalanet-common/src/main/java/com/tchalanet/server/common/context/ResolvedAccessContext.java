 ...
 *
 * <ul>
 *   <li>APP_USER: appUserId required, sellerTerminalId null.
 *   <li>SELLER_TERMINAL: sellerTerminalId required, effectiveTenantId required, appUserId null,
 *       roleCodes empty, permissionKeys limited to terminal actions.
 *   <li>SYSTEM: not produced by the HTTP access-context pipeline.
 * </ul>
 *
