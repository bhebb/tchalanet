...
public class ObservabilityBusConfig {
  ...
  public CommandBus observedCommandBus(
      SimpleCommandBus delegate, ObservationRegistry registry, TchObservabilityProperties props) {
  ...
  public QueryBus observedQueryBus(
      SimpleQueryBus delegate, ObservationRegistry registry, TchObservabilityProperties props) {
