...
public class InvalidHandlerException extends BusRegistrationException {
  ...
  public static InvalidHandlerException unresolvableMessageType(
      Class<?> handlerClass, Class<?> handlerInterface) {
  ...
  public static InvalidHandlerException nonConcreteMessageType(
      Class<?> handlerClass, Class<?> handlerInterface) {
    return new InvalidHandlerException(
        String.format(
